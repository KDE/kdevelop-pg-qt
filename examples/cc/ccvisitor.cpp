...
Visitor::ParserFuncType Visitor::sParserTable[] =
{
    ...
    reinterpret_cast<ParserFuncType>(&Visitor::visitAsm_against_mangling),
    reinterpret_cast<ParserFuncType>(&Visitor::visitAsm_specifier),
    ...
    reinterpret_cast<ParserFuncType>(&Visitor::visitExt_expression),
    ...
    reinterpret_cast<ParserFuncType>(&Visitor::visitInline_asm),
