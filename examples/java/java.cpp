...
namespace java
            ...
            if (yytoken == Token_CLASS)
              {
                ...
                if (!parse_class_declaration(&__node_49, modifiers))
                  {
                    return yy_expected_symbol(ast_node::Kind_class_declaration, "class_declaration");
                  }
            ...
            else if (yytoken == Token_ENUM)
              {
                ...
                if (!parse_enum_declaration(&__node_50, modifiers))
                  {
                    return yy_expected_symbol(ast_node::Kind_enum_declaration, "enum_declaration");
                  }
            ...
            else if (yytoken == Token_INTERFACE)
              {
                ...
                if (!parse_interface_declaration(&__node_51, modifiers))
                  {
                    return yy_expected_symbol(ast_node::Kind_interface_declaration, "interface_declaration");
                  }
            ...
            else if (yytoken == Token_AT)
              {
                ...
                if (!parse_annotation_type_declaration(&__node_52, modifiers))
                  {
                    return yy_expected_symbol(ast_node::Kind_annotation_type_declaration, "annotation_type_declaration");
                  }
    ...
    if (yytoken == Token_CATCH)
      {
        ...
        exception_parameter = __node_58;
        if (yytoken != Token_RPAREN)
          return yy_expected_token(yytoken, Token_RPAREN, ")");
        yylex();
        variable_declaration_split_data_ast *__node_59 = 0;
        if (!parse_variable_declaration_split_data(&__node_59, exception_parameter, 0))
          {
            return yy_expected_symbol(ast_node::Kind_variable_declaration_split_data, "variable_declaration_split_data");
          }
        (*yynode)->exception_declaration = __node_59;
        block_ast *__node_60 = 0;
        if (!parse_block(&__node_60))
          {
            return yy_expected_symbol(ast_node::Kind_block, "block");
          }
        (*yynode)->body = __node_60;
      }
    else
      {
        return false;
    ...
    if (yytoken == Token_LBRACE)
      {
        ...
        while (yytoken == Token_ABSTRACT
               ...
               || yytoken == Token_IDENTIFIER)
          {
            class_field_ast *__node_61 = 0;
            if (!parse_class_field(&__node_61))
              {
                return yy_expected_symbol(ast_node::Kind_class_field, "class_field");
              }
            (*yynode)->declaration_sequence = snoc((*yynode)->declaration_sequence, __node_61, memory_pool);
          }
        if (yytoken != Token_RBRACE)
          return yy_expected_token(yytoken, Token_RBRACE, "}");
        yylex();
    ...
    if (yytoken == Token_CLASS)
      {
        ...
        yylex();
        identifier_ast *__node_62 = 0;
        if (!parse_identifier(&__node_62))
          {
            return yy_expected_symbol(ast_node::Kind_identifier, "identifier");
          }
        (*yynode)->class_name = __node_62;
        if ((yytoken == Token_LESS_THAN) && ( compatibility_mode() >= java15_compatibility ))
          {
            type_parameters_ast *__node_63 = 0;
            if (!parse_type_parameters(&__node_63))
              {
                return yy_expected_symbol(ast_node::Kind_type_parameters, "type_parameters");
              }
            (*yynode)->type_parameters = __node_63;
          }
        else if (true /*epsilon*/)
        {}
        else
        ...
        if (yytoken == Token_EXTENDS)
          {
            class_extends_clause_ast *__node_64 = 0;
            if (!parse_class_extends_clause(&__node_64))
              {
                return yy_expected_symbol(ast_node::Kind_class_extends_clause, "class_extends_clause");
              }
            (*yynode)->extends = __node_64;
          }
        else if (true /*epsilon*/)
        {}
        else
        ...
        if (yytoken == Token_IMPLEMENTS)
          {
            implements_clause_ast *__node_65 = 0;
            if (!parse_implements_clause(&__node_65))
              {
                return yy_expected_symbol(ast_node::Kind_implements_clause, "implements_clause");
              }
            (*yynode)->implements = __node_65;
          }
        else if (true /*epsilon*/)
        {}
        else
        ...
        class_body_ast *__node_66 = 0;
        if (!parse_class_body(&__node_66))
          {
    ...
    if (yytoken == Token_EXTENDS)
      {
        ...
        yylex();
        class_or_interface_type_name_ast *__node_67 = 0;
        if (!parse_class_or_interface_type_name(&__node_67))
          {
            return yy_expected_symbol(ast_node::Kind_class_or_interface_type_name, "class_or_interface_type_name");
          }
        (*yynode)->type = __node_67;
      }
    else
      {
        return false;
    ...
    if (yytoken == Token_ABSTRACT
        ...
        || yytoken == Token_IDENTIFIER)
      {
        ...
        if ((yytoken == Token_ABSTRACT
          ...
          {
            optional_modifiers_ast *__node_68 = 0;
            if (!parse_optional_modifiers(&__node_68))
              {
                return yy_expected_symbol(ast_node::Kind_optional_modifiers, "optional_modifiers");
              }
            modifiers = __node_68;
            if (yytoken == Token_CLASS)
              {
                class_declaration_ast *__node_69 = 0;
                if (!parse_class_declaration(&__node_69, modifiers))
                  {
                    return yy_expected_symbol(ast_node::Kind_class_declaration, "class_declaration");
                  }
                (*yynode)->class_declaration = __node_69;
              }
            else if (yytoken == Token_ENUM)
              {
                enum_declaration_ast *__node_70 = 0;
                if (!parse_enum_declaration(&__node_70, modifiers))
                  {
                    return yy_expected_symbol(ast_node::Kind_enum_declaration, "enum_declaration");
                  }
                (*yynode)->enum_declaration = __node_70;
              }
            else if (yytoken == Token_INTERFACE)
              {
                interface_declaration_ast *__node_71 = 0;
                if (!parse_interface_declaration(&__node_71, modifiers))
                  {
                    return yy_expected_symbol(ast_node::Kind_interface_declaration, "interface_declaration");
                  }
                (*yynode)->interface_declaration = __node_71;
              }
            else if (yytoken == Token_AT)
              {
                annotation_type_declaration_ast *__node_72 = 0;
                if (!parse_annotation_type_declaration(&__node_72, modifiers))
                  {
                    return yy_expected_symbol(ast_node::Kind_annotation_type_declaration, "annotation_type_declaration");
                  }
                (*yynode)->annotation_type_declaration = __node_72;
              }
            else if (yytoken == Token_BOOLEAN
                     || yytoken == Token_BYTE
                     || yytoken == Token_CHAR
                     ...
                     || yytoken == Token_IDENTIFIER)
              {
                ...
                if ((yytoken == Token_IDENTIFIER) && ( LA(2).kind == Token_LPAREN ))
                  {
                    identifier_ast *__node_74 = 0;
                    if (!parse_identifier(&__node_74))
                      {
                        return yy_expected_symbol(ast_node::Kind_identifier, "identifier");
                      }
                    name = __node_74;
                    if (yytoken != Token_LPAREN)
                      return yy_expected_token(yytoken, Token_LPAREN, "(");
                    yylex();
                    optional_parameter_declaration_list_ast *__node_75 = 0;
                    if (!parse_optional_parameter_declaration_list(&__node_75))
                      {
                        return yy_expected_symbol(ast_node::Kind_optional_parameter_declaration_list, "optional_parameter_declaration_list");
                      }
                    parameters = __node_75;
                    if (yytoken != Token_RPAREN)
                      return yy_expected_token(yytoken, Token_RPAREN, ")");
                    yylex();
                    if (yytoken == Token_THROWS)
                      {
                        throws_clause_ast *__node_76 = 0;
                        if (!parse_throws_clause(&__node_76))
                          {
                            return yy_expected_symbol(ast_node::Kind_throws_clause, "throws_clause");
                          }
                        throws_clause = __node_76;
                      }
                    else if (true /*epsilon*/)
                    {}
                    else
                    ...
                    block_ast *__node_77 = 0;
                    if (!parse_block(&__node_77))
                      {
                        return yy_expected_symbol(ast_node::Kind_block, "block");
                      }
                    body = __node_77;
                    constructor_declaration_data_ast *__node_78 = 0;
                    if (!parse_constructor_declaration_data(&__node_78,
                         ...
                         || yytoken == Token_IDENTIFIER)
                  {
                    ...
                    if ((yytoken == Token_IDENTIFIER) && ( LA(2).kind == Token_LPAREN ))
                      {
                        identifier_ast *__node_80 = 0;
                        if (!parse_identifier(&__node_80))
                          {
                            return yy_expected_symbol(ast_node::Kind_identifier, "identifier");
                          }
                        name = __node_80;
                        if (yytoken != Token_LPAREN)
                          return yy_expected_token(yytoken, Token_LPAREN, "(");
                        yylex();
                        optional_parameter_declaration_list_ast *__node_81 = 0;
                        if (!parse_optional_parameter_declaration_list(&__node_81))
                          {
                            return yy_expected_symbol(ast_node::Kind_optional_parameter_declaration_list, "optional_parameter_declaration_list");
                          }
                        parameters = __node_81;
                        if (yytoken != Token_RPAREN)
                          return yy_expected_token(yytoken, Token_RPAREN, ")");
                        yylex();
                        optional_declarator_brackets_ast *__node_82 = 0;
                        if (!parse_optional_declarator_brackets(&__node_82))
                          {
                            return yy_expected_symbol(ast_node::Kind_optional_declarator_brackets, "optional_declarator_brackets");
                          }
                        declarator_brackets = __node_82;
                        if (yytoken == Token_THROWS)
                          {
                            throws_clause_ast *__node_83 = 0;
                            if (!parse_throws_clause(&__node_83))
                              {
                                return yy_expected_symbol(ast_node::Kind_throws_clause, "throws_clause");
                              }
                            throws_clause = __node_83;
                          }
                        else if (true /*epsilon*/)
                        {}
                        else
                        ...
                        method_declaration_data_ast *__node_85 = 0;
                        if (!parse_method_declaration_data(&__node_85,
                        ...
                        (*yynode)->method_declaration = __node_85;
                      }
                    else if ((yytoken == Token_IDENTIFIER) && ( type_parameters == 0 ))
                      {
                        variable_declarator_ast *__node_86 = 0;
                        if (!parse_variable_declarator(&__node_86))
                          {
                            return yy_expected_symbol(ast_node::Kind_variable_declarator, "variable_declarator");
                          }
                        variable_declarator_sequence = snoc(variable_declarator_sequence, __node_86, memory_pool);
                        while (yytoken == Token_COMMA)
                          {
                            if (yytoken != Token_COMMA)
                              return yy_expected_token(yytoken, Token_COMMA, ",");
                            yylex();
                            variable_declarator_ast *__node_87 = 0;
                            if (!parse_variable_declarator(&__node_87))
                              {
                                return yy_expected_symbol(ast_node::Kind_variable_declarator, "variable_declarator");
                              }
                            variable_declarator_sequence = snoc(variable_declarator_sequence, __node_87, memory_pool);
                          }
                        if (yytoken != Token_SEMICOLON)
                          return yy_expected_token(yytoken, Token_SEMICOLON, ";");
                        yylex();
        ...
        else if (yytoken == Token_LBRACE)
          {
            ...
            (*yynode)->instance_initializer_block = __node_88;
          }
        else if (yytoken == Token_STATIC)
          {
            ...
            (*yynode)->static_initializer_block = __node_89;
          }
        else if (yytoken == Token_SEMICOLON)
          {
            if (yytoken != Token_SEMICOLON)
  ...
  bool parser::parse_class_or_interface_type_name(class_or_interface_type_name_ast **yynode)
  {
    *yynode = create<class_or_interface_type_name_ast>();
    ...
    if (yytoken == Token_IDENTIFIER)
      {
        class_or_interface_type_name_part_ast *__node_90 = 0;
        if (!parse_class_or_interface_type_name_part(&__node_90))
          {
            return yy_expected_symbol(ast_node::Kind_class_or_interface_type_name_part, "class_or_interface_type_name_part");
          }
        (*yynode)->part_sequence = snoc((*yynode)->part_sequence, __node_90, memory_pool);
        while (yytoken == Token_DOT)
          {
            if (yytoken != Token_DOT)
              return yy_expected_token(yytoken, Token_DOT, ".");
            yylex();
            class_or_interface_type_name_part_ast *__node_91 = 0;
            if (!parse_class_or_interface_type_name_part(&__node_91))
              {
                return yy_expected_symbol(ast_node::Kind_class_or_interface_type_name_part, "class_or_interface_type_name_part");
              }
            (*yynode)->part_sequence = snoc((*yynode)->part_sequence, __node_91, memory_pool);
          }
      }
    else
      {
  ...
  bool parser::parse_class_or_interface_type_name_part(class_or_interface_type_name_part_ast **yynode)
  {
    *yynode = create<class_or_interface_type_name_part_ast>();
    ...
    if (yytoken == Token_IDENTIFIER)
      {
        identifier_ast *__node_92 = 0;
        if (!parse_identifier(&__node_92))
          {
            return yy_expected_symbol(ast_node::Kind_identifier, "identifier");
          }
        ...
        if ((yytoken == Token_LESS_THAN) && ( compatibility_mode() >= java15_compatibility ))
          {
            type_arguments_ast *__node_93 = 0;
            if (!parse_type_arguments(&__node_93))
              {
                return yy_expected_symbol(ast_node::Kind_type_arguments, "type_arguments");
              }
            (*yynode)->type_arguments = __node_93;
          }
        else if (true /*epsilon*/)
        {}
        else
  ...
  bool parser::parse_class_type(class_type_ast **yynode)
  {
    *yynode = create<class_type_ast>();
    ...
    if (yytoken == Token_IDENTIFIER)
      {
        class_or_interface_type_name_ast *__node_94 = 0;
        if (!parse_class_or_interface_type_name(&__node_94))
          {
            return yy_expected_symbol(ast_node::Kind_class_or_interface_type_name, "class_or_interface_type_name");
          }
        (*yynode)->type = __node_94;
        optional_declarator_brackets_ast *__node_95 = 0;
        if (!parse_optional_declarator_brackets(&__node_95))
          {
            return yy_expected_symbol(ast_node::Kind_optional_declarator_brackets, "optional_declarator_brackets");
          }
        (*yynode)->declarator_brackets = __node_95;
      }
    else
      {
        return false;
    ...
    if (yytoken == Token_ABSTRACT
        ...
        || yytoken == Token_AT || yytoken == Token_EOF)
      {
        ...
        if ((yytoken == Token_PACKAGE
          ...
          {
            package_declaration_ast *__node_96 = 0;
            if (!parse_package_declaration(&__node_96))
              {
                return yy_expected_symbol(ast_node::Kind_package_declaration, "package_declaration");
              }
            (*yynode)->package_declaration = __node_96;
          }
        else if (true /*epsilon*/)
        {}
        else
        ...
        while (yytoken == Token_IMPORT)
          {
            import_declaration_ast *__node_97 = 0;
            if (!parse_import_declaration(&__node_97))
              {
                return yy_expected_symbol(ast_node::Kind_import_declaration, "import_declaration");
              }
            (*yynode)->import_declaration_sequence = snoc((*yynode)->import_declaration_sequence, __node_97, memory_pool);
          }
        while (yytoken == Token_ABSTRACT
               || yytoken == Token_CLASS
               || yytoken == Token_ENUM
               ...
               || yytoken == Token_AT)
          {
            type_declaration_ast *__node_98 = 0;
            if (!parse_type_declaration(&__node_98))
              {
                return yy_expected_symbol(ast_node::Kind_type_declaration, "type_declaration");
              }
            (*yynode)->type_declaration_sequence = snoc((*yynode)->type_declaration_sequence, __node_98, memory_pool);
          }
  ...
  bool parser::parse_conditional_expression(conditional_expression_ast **yynode)
  {
    *yynode = create<conditional_expression_ast>();
    ...
    if (yytoken == Token_BOOLEAN
        ...
        || yytoken == Token_IDENTIFIER)
      {
        logical_or_expression_ast *__node_99 = 0;
        if (!parse_logical_or_expression(&__node_99))
          {
            return yy_expected_symbol(ast_node::Kind_logical_or_expression, "logical_or_expression");
          }
        (*yynode)->logical_or_expression = __node_99;
        if (yytoken == Token_QUESTION)
          {
            ...
            (*yynode)->if_expression = __node_100;
            if (yytoken != Token_COLON)
              return yy_expected_token(yytoken, Token_COLON, ":");
            yylex();
            conditional_expression_ast *__node_101 = 0;
            if (!parse_conditional_expression(&__node_101))
              {
                return yy_expected_symbol(ast_node::Kind_conditional_expression, "conditional_expression");
              }
            (*yynode)->else_expression = __node_101;
          }
        else if (true /*epsilon*/)
        {}
        else
        ...
        || yytoken == Token_IDENTIFIER)
      {
        ...
        if (yytoken == Token_ABSTRACT
            ...
            || yytoken == Token_IDENTIFIER)
          {
            ...
            if (yytoken == Token_CLASS)
                     ...
                     || yytoken == Token_IDENTIFIER)
              {
                ...
                if ((yytoken == Token_IDENTIFIER) && ( LA(2).kind == Token_LPAREN ))
                  {
                    identifier_ast *__node_135 = 0;
                    if (!parse_identifier(&__node_135))
                      {
                        return yy_expected_symbol(ast_node::Kind_identifier, "identifier");
                      }
                    name = __node_135;
                    if (yytoken != Token_LPAREN)
                      return yy_expected_token(yytoken, Token_LPAREN, "(");
                    yylex();
                    optional_parameter_declaration_list_ast *__node_136 = 0;
                    if (!parse_optional_parameter_declaration_list(&__node_136))
                      {
                        return yy_expected_symbol(ast_node::Kind_optional_parameter_declaration_list, "optional_parameter_declaration_list");
                      }
                    parameters = __node_136;
                    if (yytoken != Token_RPAREN)
                      return yy_expected_token(yytoken, Token_RPAREN, ")");
                    yylex();
                    optional_declarator_brackets_ast *__node_137 = 0;
                    if (!parse_optional_declarator_brackets(&__node_137))
                      {
                        return yy_expected_symbol(ast_node::Kind_optional_declarator_brackets, "optional_declarator_brackets");
                      }
                    declarator_brackets = __node_137;
                    if (yytoken == Token_THROWS)
                      {
                        throws_clause_ast *__node_138 = 0;
                        if (!parse_throws_clause(&__node_138))
                          {
                            return yy_expected_symbol(ast_node::Kind_throws_clause, "throws_clause");
                          }
                        throws_clause = __node_138;
                      }
                    else if (true /*epsilon*/)
                    {}
                    else
                    ...
                    method_declaration_data_ast *__node_140 = 0;
                    if (!parse_method_declaration_data(&__node_140,
                                                       modifiers, type_parameters, type, name, parameters,
                                                       declarator_brackets, throws_clause, body
                                                      ))
                      {
                    ...
                    (*yynode)->method_declaration = __node_140;
                  }
                else if ((yytoken == Token_IDENTIFIER) && ( type_parameters == 0 ))
                  {
                    variable_declarator_ast *__node_141 = 0;
                    if (!parse_variable_declarator(&__node_141))
                      {
                        return yy_expected_symbol(ast_node::Kind_variable_declarator, "variable_declarator");
                      }
                    variable_declarator_sequence = snoc(variable_declarator_sequence, __node_141, memory_pool);
                    while (yytoken == Token_COMMA)
                      {
                        if (yytoken != Token_COMMA)
                          return yy_expected_token(yytoken, Token_COMMA, ",");
                        yylex();
                        variable_declarator_ast *__node_142 = 0;
                        if (!parse_variable_declarator(&__node_142))
                          {
                            return yy_expected_symbol(ast_node::Kind_variable_declarator, "variable_declarator");
                          }
                        variable_declarator_sequence = snoc(variable_declarator_sequence, __node_142, memory_pool);
                      }
                    if (yytoken != Token_SEMICOLON)
                      return yy_expected_token(yytoken, Token_SEMICOLON, ";");
                    yylex();
        ...
        else if (yytoken == Token_LBRACE)
          {
            ...
            (*yynode)->instance_initializer_block = __node_143;
          }
        else if (yytoken == Token_SEMICOLON)
          {
            if (yytoken != Token_SEMICOLON)
    ...
    if (yytoken == Token_ENUM)
      {
        ...
        (*yynode)->enum_name = __node_144;
        if (yytoken == Token_IMPLEMENTS)
          {
            implements_clause_ast *__node_145 = 0;
            if (!parse_implements_clause(&__node_145))
              {
                return yy_expected_symbol(ast_node::Kind_implements_clause, "implements_clause");
              }
            (*yynode)->implements = __node_145;
          }
        else if (true /*epsilon*/)
        {}
        else
        ...
        enum_body_ast *__node_146 = 0;
        if (!parse_enum_body(&__node_146))
          {
            return yy_expected_symbol(ast_node::Kind_enum_body, "enum_body");
          }
        (*yynode)->body = __node_146;
      }
    else
      {
        return false;
  ...
  bool parser::parse_equality_expression(equality_expression_ast **yynode)
  {
    *yynode = create<equality_expression_ast>();
    ...
    if (yytoken == Token_BOOLEAN
        ...
        || yytoken == Token_IDENTIFIER)
      {
        relational_expression_ast *__node_147 = 0;
        if (!parse_relational_expression(&__node_147))
          {
            return yy_expected_symbol(ast_node::Kind_relational_expression, "relational_expression");
          }
        (*yynode)->expression = __node_147;
        while (yytoken == Token_EQUAL
               || yytoken == Token_NOT_EQUAL)
          {
            equality_expression_rest_ast *__node_148 = 0;
            if (!parse_equality_expression_rest(&__node_148))
              {
                return yy_expected_symbol(ast_node::Kind_equality_expression_rest, "equality_expression_rest");
              }
            (*yynode)->additional_expression_sequence = snoc((*yynode)->additional_expression_sequence, __node_148, memory_pool);
          }
      }
    else
      {
    ...
    *yynode = create<equality_expression_rest_ast>();
    ...
    if (yytoken == Token_EQUAL
        || yytoken == Token_NOT_EQUAL)
      {
        ...
        relational_expression_ast *__node_149 = 0;
        if (!parse_relational_expression(&__node_149))
          {
            return yy_expected_symbol(ast_node::Kind_relational_expression, "relational_expression");
          }
        (*yynode)->expression = __node_149;
      }
    else
      {
        return false;
  ...
  bool parser::parse_expression(expression_ast **yynode)
  {
    *yynode = create<expression_ast>();
    ...
    if (yytoken == Token_BOOLEAN
        ...
        || yytoken == Token_IDENTIFIER)
      {
        conditional_expression_ast *__node_150 = 0;
        if (!parse_conditional_expression(&__node_150))
          {
            return yy_expected_symbol(ast_node::Kind_conditional_expression, "conditional_expression");
          }
        (*yynode)->conditional_expression = __node_150;
        if (yytoken == Token_ASSIGN
            ...
            || yytoken == Token_UNSIGNED_RSHIFT_ASSIGN)
          {
            ...
            expression_ast *__node_151 = 0;
            if (!parse_expression(&__node_151))
              {
                return yy_expected_symbol(ast_node::Kind_expression, "expression");
              }
            (*yynode)->assignment_expression = __node_151;
          }
        else if (true /*epsilon*/)
          {
    ...
    if (yytoken == Token_SEMICOLON)
      {
        ...
        if (yytoken == Token_BOOLEAN
            ...
            || yytoken == Token_IDENTIFIER)
          {
            ...
            (*yynode)->for_condition = __node_152;
          }
        else if (true /*epsilon*/)
        {}
        else
        ...
        if (yytoken == Token_BOOLEAN
            ...
            || yytoken == Token_IDENTIFIER)
          {
            statement_expression_ast *__node_153 = 0;
            if (!parse_statement_expression(&__node_153))
              {
                return yy_expected_symbol(ast_node::Kind_statement_expression, "statement_expression");
              }
            (*yynode)->for_update_expression_sequence = snoc((*yynode)->for_update_expression_sequence, __node_153, memory_pool);
            while (yytoken == Token_COMMA)
              {
                if (yytoken != Token_COMMA)
                  return yy_expected_token(yytoken, Token_COMMA, ",");
                ...
                (*yynode)->for_update_expression_sequence = snoc((*yynode)->for_update_expression_sequence, __node_154, memory_pool);
              }
          }
        else if (true /*epsilon*/)
        {}
    ...
    if (yytoken == Token_ABSTRACT
        ...
        || yytoken == Token_IDENTIFIER)
      {
        ...
        if ((yytoken == Token_ABSTRACT
             ...
             || yytoken == Token_IDENTIFIER) && ( lookahead_is_parameter_declaration() == true ))
          {
            parameter_declaration_ast *__node_155 = 0;
            if (!parse_parameter_declaration(&__node_155))
              {
                return yy_expected_symbol(ast_node::Kind_parameter_declaration, "parameter_declaration");
              }
            vardecl_start_or_foreach_parameter = __node_155;
            if ((yytoken == Token_COLON) && ( compatibility_mode() >= java15_compatibility ))
              {
                ...
                iterable_expression = __node_156;
                foreach_declaration_data_ast *__node_157 = 0;
                if (!parse_foreach_declaration_data(&__node_157,
                ...
                (*yynode)->foreach_declaration = __node_157;
              }
            else if (yytoken == Token_SEMICOLON
                     || yytoken == Token_COMMA
                     || yytoken == Token_ASSIGN)
              {
                variable_declaration_rest_ast *__node_158 = 0;
                if (!parse_variable_declaration_rest(&__node_158))
                  {
                    return yy_expected_symbol(ast_node::Kind_variable_declaration_rest, "variable_declaration_rest");
                  }
                variable_declaration_rest = __node_158;
                variable_declaration_split_data_ast *__node_159 = 0;
                if (!parse_variable_declaration_split_data(&__node_159,
                    vardecl_start_or_foreach_parameter, variable_declaration_rest
                                                          ))
                  {
                    return yy_expected_symbol(ast_node::Kind_variable_declaration_split_data, "variable_declaration_split_data");
                  }
                (*yynode)->variable_declaration = __node_159;
          ...
          {
            for_clause_traditional_rest_ast *__node_161 = 0;
            if (!parse_for_clause_traditional_rest(&__node_161))
              {
                return yy_expected_symbol(ast_node::Kind_for_clause_traditional_rest, "for_clause_traditional_rest");
              }
            (*yynode)->traditional_for_rest = __node_161;
          }
        else if (yytoken == Token_BOOLEAN
                 || yytoken == Token_BYTE
                 || yytoken == Token_CHAR
                 ...
                 || yytoken == Token_IDENTIFIER)
          {
            statement_expression_ast *__node_162 = 0;
            if (!parse_statement_expression(&__node_162))
              {
                return yy_expected_symbol(ast_node::Kind_statement_expression, "statement_expression");
              }
            (*yynode)->statement_expression_sequence = snoc((*yynode)->statement_expression_sequence, __node_162, memory_pool);
            while (yytoken == Token_COMMA)
              {
                if (yytoken != Token_COMMA)
                  return yy_expected_token(yytoken, Token_COMMA, ",");
                ...
                (*yynode)->statement_expression_sequence = snoc((*yynode)->statement_expression_sequence, __node_163, memory_pool);
              }
    ...
    if (yytoken == Token_FOR)
      {
        ...
        if (yytoken != Token_LPAREN)
          return yy_expected_token(yytoken, Token_LPAREN, "(");
        yylex();
        for_control_ast *__node_165 = 0;
        if (!parse_for_control(&__node_165))
          {
            return yy_expected_symbol(ast_node::Kind_for_control, "for_control");
          }
        (*yynode)->for_control = __node_165;
        if (yytoken != Token_RPAREN)
          return yy_expected_token(yytoken, Token_RPAREN, ")");
        yylex();
        embedded_statement_ast *__node_166 = 0;
        if (!parse_embedded_statement(&__node_166))
          {
            return yy_expected_symbol(ast_node::Kind_embedded_statement, "embedded_statement");
          }
        (*yynode)->for_body = __node_166;
      }
    else
      {
        return false;
    ...
    if (yytoken == Token_IF)
      {
        ...
        (*yynode)->condition = __node_167;
        if (yytoken != Token_RPAREN)
          return yy_expected_token(yytoken, Token_RPAREN, ")");
        yylex();
        embedded_statement_ast *__node_168 = 0;
        if (!parse_embedded_statement(&__node_168))
          {
            return yy_expected_symbol(ast_node::Kind_embedded_statement, "embedded_statement");
          }
        (*yynode)->if_body = __node_168;
        if (yytoken == Token_ELSE)
          {
            if (yytoken != Token_ELSE)
              return yy_expected_token(yytoken, Token_ELSE, "else");
            yylex();
            embedded_statement_ast *__node_169 = 0;
            if (!parse_embedded_statement(&__node_169))
              {
                return yy_expected_symbol(ast_node::Kind_embedded_statement, "embedded_statement");
              }
            (*yynode)->else_body = __node_169;
          }
        else if (true /*epsilon*/)
        {}
        else
    ...
    if (yytoken == Token_IMPORT)
      {
        ...
        qualified_identifier_with_optional_star_ast *__node_172 = 0;
        if (!parse_qualified_identifier_with_optional_star(&__node_172))
          {
            return yy_expected_symbol(ast_node::Kind_qualified_identifier_with_optional_star, "qualified_identifier_with_optional_star");
          }
        (*yynode)->identifier_name = __node_172;
        if (yytoken != Token_SEMICOLON)
          return yy_expected_token(yytoken, Token_SEMICOLON, ";");
        yylex();
      }
    ...
    if (yytoken == Token_LBRACE)
      {
        ...
        while (yytoken == Token_ABSTRACT
               ...
               || yytoken == Token_IDENTIFIER)
          {
            interface_field_ast *__node_173 = 0;
            if (!parse_interface_field(&__node_173))
              {
                return yy_expected_symbol(ast_node::Kind_interface_field, "interface_field");
              }
            (*yynode)->declaration_sequence = snoc((*yynode)->declaration_sequence, __node_173, memory_pool);
          }
        if (yytoken != Token_RBRACE)
          return yy_expected_token(yytoken, Token_RBRACE, "}");
        yylex();
    ...
    if (yytoken == Token_INTERFACE)
      {
        ...
        (*yynode)->interface_name = __node_174;
        if ((yytoken == Token_LESS_THAN) && ( compatibility_mode() >= java15_compatibility ))
          {
            type_parameters_ast *__node_175 = 0;
            if (!parse_type_parameters(&__node_175))
              {
                return yy_expected_symbol(ast_node::Kind_type_parameters, "type_parameters");
              }
            (*yynode)->type_parameters = __node_175;
          }
        else if (true /*epsilon*/)
        {}
        else
        ...
        if (yytoken == Token_EXTENDS)
          {
            interface_extends_clause_ast *__node_176 = 0;
            if (!parse_interface_extends_clause(&__node_176))
              {
                return yy_expected_symbol(ast_node::Kind_interface_extends_clause, "interface_extends_clause");
              }
            (*yynode)->extends = __node_176;
          }
        else if (true /*epsilon*/)
        {}
        else
        ...
        interface_body_ast *__node_177 = 0;
        if (!parse_interface_body(&__node_177))
          {
            return yy_expected_symbol(ast_node::Kind_interface_body, "interface_body");
          }
        (*yynode)->body = __node_177;
      }
    else
      {
        return false;
    ...
    if (yytoken == Token_EXTENDS)
      {
        if (yytoken != Token_EXTENDS)
          return yy_expected_token(yytoken, Token_EXTENDS, "extends");
        yylex();
        class_or_interface_type_name_ast *__node_178 = 0;
        if (!parse_class_or_interface_type_name(&__node_178))
          {
            return yy_expected_symbol(ast_node::Kind_class_or_interface_type_name, "class_or_interface_type_name");
          }
        (*yynode)->type_sequence = snoc((*yynode)->type_sequence, __node_178, memory_pool);
        while (yytoken == Token_COMMA)
          {
            if (yytoken != Token_COMMA)
              return yy_expected_token(yytoken, Token_COMMA, ",");
            yylex();
            class_or_interface_type_name_ast *__node_179 = 0;
            if (!parse_class_or_interface_type_name(&__node_179))
              {
                return yy_expected_symbol(ast_node::Kind_class_or_interface_type_name, "class_or_interface_type_name");
              }
            (*yynode)->type_sequence = snoc((*yynode)->type_sequence, __node_179, memory_pool);
          }
      }
    else
      {
    ...
    if (yytoken == Token_ABSTRACT
        ...
        || yytoken == Token_IDENTIFIER)
      {
        ...
        if (yytoken == Token_ABSTRACT
            ...
            || yytoken == Token_IDENTIFIER)
          {
            optional_modifiers_ast *__node_180 = 0;
            if (!parse_optional_modifiers(&__node_180))
              {
                return yy_expected_symbol(ast_node::Kind_optional_modifiers, "optional_modifiers");
              }
            modifiers = __node_180;
            if (yytoken == Token_CLASS)
              {
                class_declaration_ast *__node_181 = 0;
                if (!parse_class_declaration(&__node_181, modifiers))
                  {
                    return yy_expected_symbol(ast_node::Kind_class_declaration, "class_declaration");
                  }
                (*yynode)->class_declaration = __node_181;
              }
            else if (yytoken == Token_ENUM)
              {
                enum_declaration_ast *__node_182 = 0;
                if (!parse_enum_declaration(&__node_182, modifiers))
                  {
                    return yy_expected_symbol(ast_node::Kind_enum_declaration, "enum_declaration");
                  }
                (*yynode)->enum_declaration = __node_182;
              }
            else if (yytoken == Token_INTERFACE)
              {
                interface_declaration_ast *__node_183 = 0;
                if (!parse_interface_declaration(&__node_183, modifiers))
                  {
                    return yy_expected_symbol(ast_node::Kind_interface_declaration, "interface_declaration");
                  }
                (*yynode)->interface_declaration = __node_183;
              }
            else if (yytoken == Token_AT)
              {
                annotation_type_declaration_ast *__node_184 = 0;
                if (!parse_annotation_type_declaration(&__node_184, modifiers))
                  {
                    return yy_expected_symbol(ast_node::Kind_annotation_type_declaration, "annotation_type_declaration");
                  }
                (*yynode)->annotation_type_declaration = __node_184;
              }
            else if (yytoken == Token_BOOLEAN
                     || yytoken == Token_BYTE
                     || yytoken == Token_CHAR
                     ...
                     || yytoken == Token_IDENTIFIER)
              {
                ...
                if ((yytoken == Token_LESS_THAN) && ( compatibility_mode() >= java15_compatibility ))
                  {
                    type_parameters_ast *__node_185 = 0;
                    if (!parse_type_parameters(&__node_185))
                      {
                        return yy_expected_symbol(ast_node::Kind_type_parameters, "type_parameters");
                      }
                    type_parameters = __node_185;
                ...
                if ((yytoken == Token_IDENTIFIER) && ( LA(2).kind == Token_LPAREN ))
                  {
                    ...
                    declarator_brackets = __node_189;
                    if (yytoken == Token_THROWS)
                      {
                    ...
                    if (yytoken != Token_SEMICOLON)
                      return yy_expected_token(yytoken, Token_SEMICOLON, ";");
                    yylex();
                    interface_method_declaration_data_ast *__node_191 = 0;
                    if (!parse_interface_method_declaration_data(&__node_191,
                        modifiers, type_parameters, type, name, parameters,
                    ...
                    (*yynode)->interface_method_declaration = __node_191;
                  }
                else if ((yytoken == Token_IDENTIFIER) && ( type_parameters == 0 ))
                  {
                    variable_declarator_ast *__node_192 = 0;
                    if (!parse_variable_declarator(&__node_192))
                      {
                        return yy_expected_symbol(ast_node::Kind_variable_declarator, "variable_declarator");
                      }
                    variable_declarator_sequence = snoc(variable_declarator_sequence, __node_192, memory_pool);
                    while (yytoken == Token_COMMA)
                      {
                        if (yytoken != Token_COMMA)
                          return yy_expected_token(yytoken, Token_COMMA, ",");
                        yylex();
                        variable_declarator_ast *__node_193 = 0;
                        if (!parse_variable_declarator(&__node_193))
                          {
                            return yy_expected_symbol(ast_node::Kind_variable_declarator, "variable_declarator");
                          }
                        variable_declarator_sequence = snoc(variable_declarator_sequence, __node_193, memory_pool);
                      }
                    if (yytoken != Token_SEMICOLON)
                      return yy_expected_token(yytoken, Token_SEMICOLON, ";");
                    yylex();
  ...
  bool parser::parse_logical_and_expression(logical_and_expression_ast **yynode)
  {
    *yynode = create<logical_and_expression_ast>();
    ...
    if (yytoken == Token_BOOLEAN
        ...
        || yytoken == Token_IDENTIFIER)
      {
        bit_or_expression_ast *__node_196 = 0;
        if (!parse_bit_or_expression(&__node_196))
          {
        ...
        while (yytoken == Token_LOG_AND)
          {
            ...
            yylex();
            bit_or_expression_ast *__node_197 = 0;
            if (!parse_bit_or_expression(&__node_197))
              {
                return yy_expected_symbol(ast_node::Kind_bit_or_expression, "bit_or_expression");
              }
            (*yynode)->expression_sequence = snoc((*yynode)->expression_sequence, __node_197, memory_pool);
          }
      }
    else
      {
  ...
  bool parser::parse_logical_or_expression(logical_or_expression_ast **yynode)
  {
    *yynode = create<logical_or_expression_ast>();
    ...
    if (yytoken == Token_BOOLEAN
        ...
        || yytoken == Token_IDENTIFIER)
      {
        logical_and_expression_ast *__node_198 = 0;
        if (!parse_logical_and_expression(&__node_198))
          {
            return yy_expected_symbol(ast_node::Kind_logical_and_expression, "logical_and_expression");
          }
        (*yynode)->expression_sequence = snoc((*yynode)->expression_sequence, __node_198, memory_pool);
        while (yytoken == Token_LOG_OR)
          {
            if (yytoken != Token_LOG_OR)
              return yy_expected_token(yytoken, Token_LOG_OR, "||");
            yylex();
            logical_and_expression_ast *__node_199 = 0;
            if (!parse_logical_and_expression(&__node_199))
              {
                return yy_expected_symbol(ast_node::Kind_logical_and_expression, "logical_and_expression");
              }
            (*yynode)->expression_sequence = snoc((*yynode)->expression_sequence, __node_199, memory_pool);
          }
      }
    else
      {
  ...
  bool parser::parse_mandatory_array_builtin_type(mandatory_array_builtin_type_ast **yynode)
  {
    *yynode = create<mandatory_array_builtin_type_ast>();
    ...
    if (yytoken == Token_BOOLEAN
        ...
        || yytoken == Token_VOID)
      {
        builtin_type_ast *__node_200 = 0;
        if (!parse_builtin_type(&__node_200))
          {
            return yy_expected_symbol(ast_node::Kind_builtin_type, "builtin_type");
          }
        (*yynode)->type = __node_200;
        mandatory_declarator_brackets_ast *__node_201 = 0;
        if (!parse_mandatory_declarator_brackets(&__node_201))
          {
            return yy_expected_symbol(ast_node::Kind_mandatory_declarator_brackets, "mandatory_declarator_brackets");
          }
  ...
  bool parser::parse_multiplicative_expression(multiplicative_expression_ast **yynode)
  {
    *yynode = create<multiplicative_expression_ast>();
    ...
    if (yytoken == Token_BOOLEAN
        ...
        || yytoken == Token_IDENTIFIER)
      {
        unary_expression_ast *__node_202 = 0;
        if (!parse_unary_expression(&__node_202))
          {
            return yy_expected_symbol(ast_node::Kind_unary_expression, "unary_expression");
          }
        (*yynode)->expression = __node_202;
        while (yytoken == Token_STAR
               || yytoken == Token_SLASH
               || yytoken == Token_REMAINDER)
          {
            multiplicative_expression_rest_ast *__node_203 = 0;
            if (!parse_multiplicative_expression_rest(&__node_203))
              {
                return yy_expected_symbol(ast_node::Kind_multiplicative_expression_rest, "multiplicative_expression_rest");
              }
            (*yynode)->additional_expression_sequence = snoc((*yynode)->additional_expression_sequence, __node_203, memory_pool);
          }
      }
    else
      {
    ...
    if (yytoken == Token_NEW)
      {
        ...
        if ((yytoken == Token_LESS_THAN) && ( compatibility_mode() >= java15_compatibility ))
          {
            non_wildcard_type_arguments_ast *__node_205 = 0;
            if (!parse_non_wildcard_type_arguments(&__node_205))
              {
                return yy_expected_symbol(ast_node::Kind_non_wildcard_type_arguments, "non_wildcard_type_arguments");
              }
            (*yynode)->type_arguments = __node_205;
          }
        else if (true /*epsilon*/)
        {}
        else
        ...
        non_array_type_ast *__node_206 = 0;
        if (!parse_non_array_type(&__node_206))
          {
        ...
        if (yytoken == Token_LPAREN)
          {
            if (yytoken != Token_LPAREN)
              return yy_expected_token(yytoken, Token_LPAREN, "(");
            yylex();
            optional_argument_list_ast *__node_207 = 0;
            if (!parse_optional_argument_list(&__node_207))
              {
                return yy_expected_symbol(ast_node::Kind_optional_argument_list, "optional_argument_list");
              }
            (*yynode)->class_constructor_arguments = __node_207;
            if (yytoken != Token_RPAREN)
              return yy_expected_token(yytoken, Token_RPAREN, ")");
            yylex();
            if (yytoken == Token_LBRACE)
              {
                class_body_ast *__node_208 = 0;
                if (!parse_class_body(&__node_208))
                  {
                    return yy_expected_symbol(ast_node::Kind_class_body, "class_body");
                  }
                (*yynode)->class_body = __node_208;
              }
            else if (true /*epsilon*/)
            {}
            else
          ...
          {
            array_creator_rest_ast *__node_209 = 0;
            if (!parse_array_creator_rest(&__node_209))
              {
                return yy_expected_symbol(ast_node::Kind_array_creator_rest, "array_creator_rest");
              }
            (*yynode)->array_creator_rest = __node_209;
          }
        else
          {
            return false;
    ...
    *yynode = create<non_array_type_ast>();
    ...
    if (yytoken == Token_BOOLEAN
        ...
        || yytoken == Token_IDENTIFIER)
      {
        if (yytoken == Token_IDENTIFIER)
          {
            class_or_interface_type_name_ast *__node_210 = 0;
            if (!parse_class_or_interface_type_name(&__node_210))
              {
                return yy_expected_symbol(ast_node::Kind_class_or_interface_type_name, "class_or_interface_type_name");
              }
            (*yynode)->class_or_interface_type = __node_210;
          }
        else if (yytoken == Token_BOOLEAN
                 || yytoken == Token_BYTE
                 || yytoken == Token_CHAR
                 ...
                 || yytoken == Token_VOID)
          {
            builtin_type_ast *__node_211 = 0;
            if (!parse_builtin_type(&__node_211))
              {
                return yy_expected_symbol(ast_node::Kind_builtin_type, "builtin_type");
              }
            (*yynode)->builtin_type = __node_211;
          }
        else
          {
            return false;
    ...
    if (yytoken == Token_LESS_THAN)
      {
        ...
        ltCounter++;
        type_argument_type_ast *__node_212 = 0;
        if (!parse_type_argument_type(&__node_212))
          {
            return yy_expected_symbol(ast_node::Kind_type_argument_type, "type_argument_type");
          }
        (*yynode)->type_argument_type_sequence = snoc((*yynode)->type_argument_type_sequence, __node_212, memory_pool);
        while (yytoken == Token_COMMA)
          {
            ...
            if (yytoken != Token_COMMA)
              return yy_expected_token(yytoken, Token_COMMA, ",");
            yylex();
            type_argument_type_ast *__node_213 = 0;
            if (!parse_type_argument_type(&__node_213))
              {
                return yy_expected_symbol(ast_node::Kind_type_argument_type, "type_argument_type");
              }
            (*yynode)->type_argument_type_sequence = snoc((*yynode)->type_argument_type_sequence, __node_213, memory_pool);
          }
        if (yytoken == Token_GREATER_THAN
            || yytoken == Token_SIGNED_RSHIFT
            || yytoken == Token_UNSIGNED_RSHIFT)
          {
            type_arguments_or_parameters_end_ast *__node_214 = 0;
            if (!parse_type_arguments_or_parameters_end(&__node_214))
              {
    ...
    if (yytoken == Token_BOOLEAN
        ...
        || yytoken == Token_IDENTIFIER || yytoken == Token_RPAREN)
      {
        if (yytoken == Token_BOOLEAN
            ...
            || yytoken == Token_IDENTIFIER)
          {
            expression_ast *__node_215 = 0;
            if (!parse_expression(&__node_215))
              {
                return yy_expected_symbol(ast_node::Kind_expression, "expression");
              }
            (*yynode)->expression_sequence = snoc((*yynode)->expression_sequence, __node_215, memory_pool);
            while (yytoken == Token_COMMA)
              {
                if (yytoken != Token_COMMA)
                  return yy_expected_token(yytoken, Token_COMMA, ",");
                yylex();
                expression_ast *__node_216 = 0;
                if (!parse_expression(&__node_216))
                  {
                    return yy_expected_symbol(ast_node::Kind_expression, "expression");
                  }
                (*yynode)->expression_sequence = snoc((*yynode)->expression_sequence, __node_216, memory_pool);
              }
          }
        else if (true /*epsilon*/)
        {}
  ...
  bool parser::parse_optional_array_builtin_type(optional_array_builtin_type_ast **yynode)
  {
    *yynode = create<optional_array_builtin_type_ast>();
    ...
    if (yytoken == Token_BOOLEAN
        ...
        || yytoken == Token_VOID)
      {
        builtin_type_ast *__node_217 = 0;
        if (!parse_builtin_type(&__node_217))
          {
            return yy_expected_symbol(ast_node::Kind_builtin_type, "builtin_type");
          }
        (*yynode)->type = __node_217;
        optional_declarator_brackets_ast *__node_218 = 0;
        if (!parse_optional_declarator_brackets(&__node_218))
          {
            return yy_expected_symbol(ast_node::Kind_optional_declarator_brackets, "optional_declarator_brackets");
          }
        (*yynode)->declarator_brackets = __node_218;
      }
    else
      {
        return false;
               ...
               || yytoken == Token_AT)
          {
            if (yytoken == Token_PRIVATE)
            ...
            else if (yytoken == Token_AT)
              {
                ...
                annotation_ast *__node_219 = 0;
                if (!parse_annotation(&__node_219))
                  {
                    return yy_expected_symbol(ast_node::Kind_annotation, "annotation");
                  }
                (*yynode)->mod_annotation_sequence = snoc((*yynode)->mod_annotation_sequence, __node_219, memory_pool);
              }
            else
              {
                return false;
    ...
    if (yytoken == Token_BOOLEAN
        ...
        || yytoken == Token_IDENTIFIER || yytoken == Token_RPAREN)
      {
        ...
        if (yytoken == Token_BOOLEAN
            ...
            || yytoken == Token_IDENTIFIER)
          {
            parameter_declaration_ellipsis_ast *__node_220 = 0;
            if (!parse_parameter_declaration_ellipsis(&__node_220, &ellipsis_occurred))
              {
                return yy_expected_symbol(ast_node::Kind_parameter_declaration_ellipsis, "parameter_declaration_ellipsis");
              }
            (*yynode)->parameter_declaration_sequence = snoc((*yynode)->parameter_declaration_sequence, __node_220, memory_pool);
            while (yytoken == Token_COMMA)
              {
                ...
                if (yytoken != Token_COMMA)
                  return yy_expected_token(yytoken, Token_COMMA, ",");
                yylex();
                parameter_declaration_ellipsis_ast *__node_221 = 0;
                if (!parse_parameter_declaration_ellipsis(&__node_221, &ellipsis_occurred))
                  {
                    return yy_expected_symbol(ast_node::Kind_parameter_declaration_ellipsis, "parameter_declaration_ellipsis");
                  }
                (*yynode)->parameter_declaration_sequence = snoc((*yynode)->parameter_declaration_sequence, __node_221, memory_pool);
              }
          }
        else if (true /*epsilon*/)
        {}
        ...
        while (yytoken == Token_FINAL
               || yytoken == Token_AT)
          {
            if (yytoken == Token_FINAL)
              ...
              {
                annotation_ast *__node_222 = 0;
                if (!parse_annotation(&__node_222))
                  {
                    return yy_expected_symbol(ast_node::Kind_annotation, "annotation");
                  }
                (*yynode)->mod_annotation_sequence = snoc((*yynode)->mod_annotation_sequence, __node_222, memory_pool);
              }
            else
              {
                return false;
        ...
        while (yytoken == Token_AT)
          {
            ...
            (*yynode)->annotation_sequence = snoc((*yynode)->annotation_sequence, __node_223, memory_pool);
          }
        if (yytoken != Token_PACKAGE)
          return yy_expected_token(yytoken, Token_PACKAGE, "package");
        yylex();
        qualified_identifier_ast *__node_224 = 0;
        if (!parse_qualified_identifier(&__node_224))
          {
            return yy_expected_symbol(ast_node::Kind_qualified_identifier, "qualified_identifier");
          }
        (*yynode)->package_name = __node_224;
        if (yytoken != Token_SEMICOLON)
          return yy_expected_token(yytoken, Token_SEMICOLON, ";");
        yylex();
      }
  ...
  bool parser::parse_parameter_declaration(parameter_declaration_ast **yynode)
  {
    *yynode = create<parameter_declaration_ast>();
    ...
    if (yytoken == Token_ABSTRACT
        ...
        || yytoken == Token_IDENTIFIER)
      {
        optional_modifiers_ast *__node_225 = 0;
        if (!parse_optional_modifiers(&__node_225))
          {
            return yy_expected_symbol(ast_node::Kind_optional_modifiers, "optional_modifiers");
          }
        (*yynode)->parameter_modifiers = __node_225;
        type_ast *__node_226 = 0;
        if (!parse_type(&__node_226))
          {
            return yy_expected_symbol(ast_node::Kind_type, "type");
          }
        (*yynode)->type = __node_226;
        identifier_ast *__node_227 = 0;
        if (!parse_identifier(&__node_227))
          {
            return yy_expected_symbol(ast_node::Kind_identifier, "identifier");
          }
        (*yynode)->variable_name = __node_227;
        optional_declarator_brackets_ast *__node_228 = 0;
        if (!parse_optional_declarator_brackets(&__node_228))
          {
            return yy_expected_symbol(ast_node::Kind_optional_declarator_brackets, "optional_declarator_brackets");
          }
        (*yynode)->declarator_brackets = __node_228;
      }
    else
      {
        return false;
  ...
  bool parser::parse_parameter_declaration_ellipsis(parameter_declaration_ellipsis_ast **yynode, bool* ellipsis_occurred)
  {
    *yynode = create<parameter_declaration_ellipsis_ast>();
    ...
    if (yytoken == Token_BOOLEAN
        ...
        || yytoken == Token_IDENTIFIER)
      {
        optional_parameter_modifiers_ast *__node_229 = 0;
        if (!parse_optional_parameter_modifiers(&__node_229))
          {
    ...
    if (yytoken == Token_BOOLEAN
        ...
        || yytoken == Token_IDENTIFIER)
      {
        if (yytoken == Token_BOOLEAN
            ...
            || yytoken == Token_VOID)
          {
            optional_array_builtin_type_ast *__node_233 = 0;
            if (!parse_optional_array_builtin_type(&__node_233))
              {
                return yy_expected_symbol(ast_node::Kind_optional_array_builtin_type, "optional_array_builtin_type");
              }
            (*yynode)->builtin_type = __node_233;
            if (yytoken != Token_DOT)
              return yy_expected_token(yytoken, Token_DOT, ".");
            yylex();
            if (yytoken != Token_CLASS)
        ...
        else if (yytoken == Token_LPAREN)
          {
            ...
            (*yynode)->parenthesis_expression = __node_236;
            if (yytoken != Token_RPAREN)
              return yy_expected_token(yytoken, Token_RPAREN, ")");
            yylex();
            ...
            if (yytoken == Token_LPAREN)
              {
                if (yytoken != Token_LPAREN)
                  return yy_expected_token(yytoken, Token_LPAREN, "(");
                yylex();
                optional_argument_list_ast *__node_237 = 0;
                if (!parse_optional_argument_list(&__node_237))
                  {
                    return yy_expected_symbol(ast_node::Kind_optional_argument_list, "optional_argument_list");
                  }
                (*yynode)->this_constructor_arguments = __node_237;
                if (yytoken != Token_RPAREN)
                  return yy_expected_token(yytoken, Token_RPAREN, ")");
                yylex();
              }
        ...
        else if (yytoken == Token_SUPER)
          {
            ...
            yylex();
            super_suffix_ast *__node_238 = 0;
            if (!parse_super_suffix(&__node_238))
              {
                return yy_expected_symbol(ast_node::Kind_super_suffix, "super_suffix");
              }
            (*yynode)->super_suffix = __node_238;
          ...
          {
            non_wildcard_type_arguments_ast *__node_239 = 0;
            if (!parse_non_wildcard_type_arguments(&__node_239))
              {
                return yy_expected_symbol(ast_node::Kind_non_wildcard_type_arguments, "non_wildcard_type_arguments");
              }
            (*yynode)->type_arguments = __node_239;
            if (yytoken == Token_SUPER)
              {
                if (yytoken != Token_SUPER)
                  return yy_expected_token(yytoken, Token_SUPER, "super");
                yylex();
                super_suffix_ast *__node_240 = 0;
                if (!parse_super_suffix(&__node_240))
                  {
                    return yy_expected_symbol(ast_node::Kind_super_suffix, "super_suffix");
                  }
                (*yynode)->super_suffix = __node_240;
            ...
            else if (yytoken == Token_THIS)
              {
                ...
                (*yynode)->this_constructor_arguments = __node_241;
                if (yytoken != Token_RPAREN)
                  return yy_expected_token(yytoken, Token_RPAREN, ")");
                yylex();
            ...
            else if (yytoken == Token_IDENTIFIER)
              {
                ...
                (*yynode)->method_name_typed = __node_242;
                if (yytoken != Token_LPAREN)
                  return yy_expected_token(yytoken, Token_LPAREN, "(");
                yylex();
                optional_argument_list_ast *__node_243 = 0;
                if (!parse_optional_argument_list(&__node_243))
                  {
                    return yy_expected_symbol(ast_node::Kind_optional_argument_list, "optional_argument_list");
                  }
                (*yynode)->method_arguments = __node_243;
                if (yytoken != Token_RPAREN)
                  return yy_expected_token(yytoken, Token_RPAREN, ")");
                yylex();
          ...
          {
            qualified_identifier_safe_ast *__node_244 = 0;
            if (!parse_qualified_identifier_safe(&__node_244))
              {
                return yy_expected_symbol(ast_node::Kind_qualified_identifier_safe, "qualified_identifier_safe");
              }
            (*yynode)->identifier = __node_244;
            if (yytoken == Token_LPAREN)
              {
                if (yytoken != Token_LPAREN)
                  return yy_expected_token(yytoken, Token_LPAREN, "(");
              ...
              {
                mandatory_declarator_brackets_ast *__node_246 = 0;
                if (!parse_mandatory_declarator_brackets(&__node_246))
                  {
                    return yy_expected_symbol(ast_node::Kind_mandatory_declarator_brackets, "mandatory_declarator_brackets");
                  }
                (*yynode)->declarator_brackets = __node_246;
                if (yytoken != Token_DOT)
                  return yy_expected_token(yytoken, Token_DOT, ".");
                yylex();
                if (yytoken != Token_CLASS)
  ...
  bool parser::parse_primary_expression(primary_expression_ast **yynode)
  {
    *yynode = create<primary_expression_ast>();
    ...
    if (yytoken == Token_BOOLEAN
        ...
        || yytoken == Token_IDENTIFIER)
      {
        primary_atom_ast *__node_247 = 0;
        if (!parse_primary_atom(&__node_247))
          {
            return yy_expected_symbol(ast_node::Kind_primary_atom, "primary_atom");
          }
        (*yynode)->primary_atom = __node_247;
        while (yytoken == Token_LBRACKET
               || yytoken == Token_DOT)
          {
            primary_selector_ast *__node_248 = 0;
            if (!parse_primary_selector(&__node_248))
              {
                return yy_expected_symbol(ast_node::Kind_primary_selector, "primary_selector");
              }
            (*yynode)->selector_sequence = snoc((*yynode)->selector_sequence, __node_248, memory_pool);
          }
      }
    else
      {
        ...
        if (yytoken == Token_DOT)
          {
            ...
            if (yytoken == Token_CLASS)
              ...
              {
                new_expression_ast *__node_249 = 0;
                if (!parse_new_expression(&__node_249))
                  {
                    return yy_expected_symbol(ast_node::Kind_new_expression, "new_expression");
                  }
                (*yynode)->new_expression = __node_249;
            ...
            else if ((yytoken == Token_IDENTIFIER) && ( LA(2).kind != Token_LPAREN ))
              {
                ...
                (*yynode)->variable_name = __node_250;
                     ...
                     || yytoken == Token_IDENTIFIER)
              {
                if ((yytoken == Token_LESS_THAN) && ( compatibility_mode() >= java15_compatibility ))
                  {
                    non_wildcard_type_arguments_ast *__node_251 = 0;
                    if (!parse_non_wildcard_type_arguments(&__node_251))
                      {
                        return yy_expected_symbol(ast_node::Kind_non_wildcard_type_arguments, "non_wildcard_type_arguments");
                      }
                    (*yynode)->type_arguments = __node_251;
                  }
                else if (true /*epsilon*/)
                {}
                else
                ...
                if (yytoken == Token_SUPER)
                  {
                    if (yytoken != Token_SUPER)
                      return yy_expected_token(yytoken, Token_SUPER, "super");
                    yylex();
                    super_suffix_ast *__node_252 = 0;
                    if (!parse_super_suffix(&__node_252))
                      {
                        return yy_expected_symbol(ast_node::Kind_super_suffix, "super_suffix");
                      }
                    (*yynode)->super_suffix = __node_252;
                ...
                else if (yytoken == Token_IDENTIFIER)
                  {
                    ...
                    (*yynode)->method_arguments = __node_254;
                    if (yytoken != Token_RPAREN)
                      return yy_expected_token(yytoken, Token_RPAREN, ")");
                    yylex();
        ...
        else if (yytoken == Token_LBRACKET)
          {
            if (yytoken != Token_LBRACKET)
              return yy_expected_token(yytoken, Token_LBRACKET, "[");
            yylex();
            expression_ast *__node_255 = 0;
            if (!parse_expression(&__node_255))
              {
                return yy_expected_symbol(ast_node::Kind_expression, "expression");
              }
            (*yynode)->array_index_expression = __node_255;
            if (yytoken != Token_RBRACKET)
              return yy_expected_token(yytoken, Token_RBRACKET, "]");
            yylex();
  ...
  bool parser::parse_qualified_identifier(qualified_identifier_ast **yynode)
  {
    *yynode = create<qualified_identifier_ast>();
    ...
    if (yytoken == Token_IDENTIFIER)
      {
        identifier_ast *__node_256 = 0;
        if (!parse_identifier(&__node_256))
          {
            return yy_expected_symbol(ast_node::Kind_identifier, "identifier");
          }
        (*yynode)->name_sequence = snoc((*yynode)->name_sequence, __node_256, memory_pool);
        while (yytoken == Token_DOT)
          {
            if (yytoken != Token_DOT)
              return yy_expected_token(yytoken, Token_DOT, ".");
            ...
            (*yynode)->name_sequence = snoc((*yynode)->name_sequence, __node_257, memory_pool);
          }
      }
    else
      {
  ...
  bool parser::parse_qualified_identifier_safe(qualified_identifier_safe_ast **yynode)
  {
    *yynode = create<qualified_identifier_safe_ast>();
    ...
    if (yytoken == Token_IDENTIFIER)
      {
        identifier_ast *__node_258 = 0;
        if (!parse_identifier(&__node_258))
          {
            return yy_expected_symbol(ast_node::Kind_identifier, "identifier");
          }
        (*yynode)->name_sequence = snoc((*yynode)->name_sequence, __node_258, memory_pool);
        while (yytoken == Token_DOT)
          {
            ...
            if (yytoken != Token_DOT)
              return yy_expected_token(yytoken, Token_DOT, ".");
            yylex();
            identifier_ast *__node_259 = 0;
            if (!parse_identifier(&__node_259))
              {
                return yy_expected_symbol(ast_node::Kind_identifier, "identifier");
              }
            (*yynode)->name_sequence = snoc((*yynode)->name_sequence, __node_259, memory_pool);
          }
      }
    else
      {
  ...
  bool parser::parse_qualified_identifier_with_optional_star(qualified_identifier_with_optional_star_ast **yynode)
  {
    *yynode = create<qualified_identifier_with_optional_star_ast>();
    ...
    if (yytoken == Token_IDENTIFIER)
      {
        identifier_ast *__node_260 = 0;
        if (!parse_identifier(&__node_260))
          {
            return yy_expected_symbol(ast_node::Kind_identifier, "identifier");
          }
        (*yynode)->name_sequence = snoc((*yynode)->name_sequence, __node_260, memory_pool);
        ...
        while (yytoken == Token_DOT)
          {
            ...
            if (yytoken == Token_IDENTIFIER)
              {
                identifier_ast *__node_261 = 0;
                if (!parse_identifier(&__node_261))
                  {
                    return yy_expected_symbol(ast_node::Kind_identifier, "identifier");
                  }
                (*yynode)->name_sequence = snoc((*yynode)->name_sequence, __node_261, memory_pool);
              }
  ...
  bool parser::parse_relational_expression(relational_expression_ast **yynode)
  {
    *yynode = create<relational_expression_ast>();
    ...
    if (yytoken == Token_BOOLEAN
        ...
        || yytoken == Token_IDENTIFIER)
      {
        shift_expression_ast *__node_262 = 0;
        if (!parse_shift_expression(&__node_262))
          {
        ...
        if (yytoken == Token_LESS_THAN
            ...
            || yytoken == Token_GREATER_EQUAL)
          {
            do
              {
                relational_expression_rest_ast *__node_263 = 0;
                if (!parse_relational_expression_rest(&__node_263))
                  {
        ...
        else if (yytoken == Token_INSTANCEOF)
          {
            ...
            yylex();
            type_ast *__node_264 = 0;
            if (!parse_type(&__node_264))
              {
                return yy_expected_symbol(ast_node::Kind_type, "type");
              }
            (*yynode)->instanceof_type = __node_264;
          }
        else if (true /*epsilon*/)
        {}
        else
    ...
    *yynode = create<relational_expression_rest_ast>();
    ...
    if (yytoken == Token_LESS_THAN
        ...
        || yytoken == Token_GREATER_EQUAL)
      {
        ...
        shift_expression_ast *__node_265 = 0;
        if (!parse_shift_expression(&__node_265))
          {
            return yy_expected_symbol(ast_node::Kind_shift_expression, "shift_expression");
          }
  ...
  bool parser::parse_return_statement(return_statement_ast **yynode)
                             ...
                             if (yytoken == Token_RETURN)
                               {
                                 ...
                                 if (yytoken == Token_BOOLEAN
                                     ...
                                     || yytoken == Token_IDENTIFIER)
                                   {
                                     ...
                                     (*yynode)->return_expression = __node_266;
                                   }
                                 else if (true /*epsilon*/)
                                 {}
                                 else
                           ...
                           bool parser::parse_shift_expression(shift_expression_ast **yynode)
                           {
                             *yynode = create<shift_expression_ast>();
                             ...
                             if (yytoken == Token_BOOLEAN
                                 ...
                                 || yytoken == Token_IDENTIFIER)
                               {
                                 additive_expression_ast *__node_267 = 0;
                                 if (!parse_additive_expression(&__node_267))
                                   {
                                 ...
                                 while (yytoken == Token_LSHIFT
                                        ...
                                        || yytoken == Token_UNSIGNED_RSHIFT)
                                   {
                                     shift_expression_rest_ast *__node_268 = 0;
                                     if (!parse_shift_expression_rest(&__node_268))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_shift_expression_rest, "shift_expression_rest");
                                       }
                                     (*yynode)->additional_expression_sequence = snoc((*yynode)->additional_expression_sequence, __node_268, memory_pool);
                                   }
                               }
                             else
                               {
                             ...
                             *yynode = create<shift_expression_rest_ast>();
                             ...
                             if (yytoken == Token_LSHIFT
                                 ...
                                 || yytoken == Token_UNSIGNED_RSHIFT)
                               {
                                 ...
                                 additive_expression_ast *__node_269 = 0;
                                 if (!parse_additive_expression(&__node_269))
                                   {
                                     return yy_expected_symbol(ast_node::Kind_additive_expression, "additive_expression");
                                   }
                                 ...
                                 if (yytoken == Token_LPAREN)
                                   {
                                     if (yytoken != Token_LPAREN)
                                       return yy_expected_token(yytoken, Token_LPAREN, "(");
                                     yylex();
                                     optional_argument_list_ast *__node_271 = 0;
                                     if (!parse_optional_argument_list(&__node_271))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_optional_argument_list, "optional_argument_list");
                                       }
                                     (*yynode)->constructor_arguments = __node_271;
                                     if (yytoken != Token_RPAREN)
                                       return yy_expected_token(yytoken, Token_RPAREN, ")");
                                     yylex();
                                   }
                                     ...
                                     if ((yytoken == Token_IDENTIFIER) && ( LA(2).kind != Token_LPAREN ))
                                       {
                                         ...
                                         (*yynode)->variable_name = __node_272;
                                       }
                                              ...
                                              || yytoken == Token_IDENTIFIER)
                                       {
                                         if ((yytoken == Token_LESS_THAN) && ( compatibility_mode() >= java15_compatibility ))
                                           {
                                             non_wildcard_type_arguments_ast *__node_273 = 0;
                                             if (!parse_non_wildcard_type_arguments(&__node_273))
                                               {
                                                 return yy_expected_symbol(ast_node::Kind_non_wildcard_type_arguments, "non_wildcard_type_arguments");
                                               }
                                             (*yynode)->type_arguments = __node_273;
                                           }
                                         else if (true /*epsilon*/)
                                         {}
                                         else
                                         ...
                                         (*yynode)->method_name = __node_274;
                                         if (yytoken == Token_LPAREN)
                                           {
                                             if (yytoken != Token_LPAREN)
                                               return yy_expected_token(yytoken, Token_LPAREN, "(");
                                             yylex();
                                             optional_argument_list_ast *__node_275 = 0;
                                             if (!parse_optional_argument_list(&__node_275))
                                               {
                                                 return yy_expected_symbol(ast_node::Kind_optional_argument_list, "optional_argument_list");
                                               }
                                             (*yynode)->method_arguments = __node_275;
                                             if (yytoken != Token_RPAREN)
                                               return yy_expected_token(yytoken, Token_RPAREN, ")");
                                             yylex();
                                           }
                                 ...
                                 if (yytoken == Token_CASE)
                                   {
                                     ...
                                     yylex();
                                     expression_ast *__node_276 = 0;
                                     if (!parse_expression(&__node_276))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_expression, "expression");
                                       }
                                     (*yynode)->case_expression = __node_276;
                             ...
                             *yynode = create<switch_section_ast>();
                             ...
                             if (yytoken == Token_CASE
                                 || yytoken == Token_DEFAULT)
                               {
                                 do
                                   {
                                     switch_label_ast *__node_277 = 0;
                                     if (!parse_switch_label(&__node_277))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_switch_label, "switch_label");
                                       }
                                     (*yynode)->label_sequence = snoc((*yynode)->label_sequence, __node_277, memory_pool);
                                   }
                                 ...
                                 while (yytoken == Token_ABSTRACT
                                        ...
                                        || yytoken == Token_IDENTIFIER)
                                   {
                                     block_statement_ast *__node_278 = 0;
                                     if (!parse_block_statement(&__node_278))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_block_statement, "block_statement");
                                       }
                                     (*yynode)->statement_sequence = snoc((*yynode)->statement_sequence, __node_278, memory_pool);
                                   }
                               }
                             else
                               {
                             ...
                             if (yytoken == Token_SWITCH)
                               {
                                 ...
                                 (*yynode)->switch_expression = __node_279;
                                 if (yytoken != Token_RPAREN)
                                   return yy_expected_token(yytoken, Token_RPAREN, ")");
                                 yylex();
                                 if (yytoken != Token_LBRACE)
                                 ...
                                 while (yytoken == Token_CASE
                                        || yytoken == Token_DEFAULT)
                                   {
                                     switch_section_ast *__node_280 = 0;
                                     if (!parse_switch_section(&__node_280))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_switch_section, "switch_section");
                                       }
                                     (*yynode)->switch_section_sequence = snoc((*yynode)->switch_section_sequence, __node_280, memory_pool);
                                   }
                                 if (yytoken != Token_RBRACE)
                                   return yy_expected_token(yytoken, Token_RBRACE, "}");
                                 yylex();
                             ...
                             if (yytoken == Token_SYNCHRONIZED)
                               {
                                 ...
                                 (*yynode)->locked_type = __node_281;
                                 if (yytoken != Token_RPAREN)
                                   return yy_expected_token(yytoken, Token_RPAREN, ")");
                                 yylex();
                                 block_ast *__node_282 = 0;
                                 if (!parse_block(&__node_282))
                                   {
                                     return yy_expected_symbol(ast_node::Kind_block, "block");
                                   }
                                 (*yynode)->synchronized_body = __node_282;
                               }
                             else
                               {
                                 return false;
                             ...
                             if (yytoken == Token_THROWS)
                               {
                                 ...
                                 yylex();
                                 qualified_identifier_ast *__node_284 = 0;
                                 if (!parse_qualified_identifier(&__node_284))
                                   {
                                     return yy_expected_symbol(ast_node::Kind_qualified_identifier, "qualified_identifier");
                                   }
                                 (*yynode)->identifier_sequence = snoc((*yynode)->identifier_sequence, __node_284, memory_pool);
                                 while (yytoken == Token_COMMA)
                                   {
                                     if (yytoken != Token_COMMA)
                                       return yy_expected_token(yytoken, Token_COMMA, ",");
                                     yylex();
                                     qualified_identifier_ast *__node_285 = 0;
                                     if (!parse_qualified_identifier(&__node_285))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_qualified_identifier, "qualified_identifier");
                                       }
                                     (*yynode)->identifier_sequence = snoc((*yynode)->identifier_sequence, __node_285, memory_pool);
                                   }
                               }
                             else
                               {
                             ...
                             if (yytoken == Token_TRY)
                               {
                                 ...
                                 yylex();
                                 block_ast *__node_286 = 0;
                                 if (!parse_block(&__node_286))
                                   {
                                     return yy_expected_symbol(ast_node::Kind_block, "block");
                                   }
                                 (*yynode)->try_body = __node_286;
                                 if (yytoken == Token_CATCH)
                                   {
                                     do
                                       {
                                         catch_clause_ast *__node_287 = 0;
                                         if (!parse_catch_clause(&__node_287))
                                           {
                                             return yy_expected_symbol(ast_node::Kind_catch_clause, "catch_clause");
                                           }
                                         (*yynode)->catch_clause_sequence = snoc((*yynode)->catch_clause_sequence, __node_287, memory_pool);
                                       }
                                     ...
                                     if (yytoken == Token_FINALLY)
                                       {
                                         ...
                                         yylex();
                                         block_ast *__node_288 = 0;
                                         if (!parse_block(&__node_288))
                                           {
                                             return yy_expected_symbol(ast_node::Kind_block, "block");
                                           }
                                         (*yynode)->finally_body = __node_288;
                                       }
                                     else if (true /*epsilon*/)
                                     {}
                                     else
                                 ...
                                 else if (yytoken == Token_FINALLY)
                                   {
                                     if (yytoken != Token_FINALLY)
                                       return yy_expected_token(yytoken, Token_FINALLY, "finally");
                                     yylex();
                                     block_ast *__node_289 = 0;
                                     if (!parse_block(&__node_289))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_block, "block");
                                       }
                                     (*yynode)->finally_body = __node_289;
                                   }
                                 else
                                   {
                                     return false;
                             ...
                             *yynode = create<type_ast>();
                             ...
                             if (yytoken == Token_BOOLEAN
                                 ...
                                 || yytoken == Token_IDENTIFIER)
                               {
                                 if (yytoken == Token_IDENTIFIER)
                                   {
                                     class_type_ast *__node_290 = 0;
                                     if (!parse_class_type(&__node_290))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_class_type, "class_type");
                                       }
                                     (*yynode)->class_type = __node_290;
                                   }
                                 else if (yytoken == Token_BOOLEAN
                                          || yytoken == Token_BYTE
                                          || yytoken == Token_CHAR
                                          ...
                                          || yytoken == Token_VOID)
                                   {
                                     optional_array_builtin_type_ast *__node_291 = 0;
                                     if (!parse_optional_array_builtin_type(&__node_291))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_optional_array_builtin_type, "optional_array_builtin_type");
                                       }
                                     (*yynode)->builtin_type = __node_291;
                                   }
                                 else
                                   {
                                     return false;
                             ...
                             if (yytoken == Token_BOOLEAN
                                 ...
                                 || yytoken == Token_IDENTIFIER)
                               {
                                 if (yytoken == Token_BOOLEAN
                                     ...
                                     || yytoken == Token_IDENTIFIER)
                                   {
                                     type_argument_type_ast *__node_292 = 0;
                                     if (!parse_type_argument_type(&__node_292))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_type_argument_type, "type_argument_type");
                                       }
                                     (*yynode)->type_argument_type = __node_292;
                                   }
                                 else if (yytoken == Token_QUESTION)
                                   {
                                     wildcard_type_ast *__node_293 = 0;
                                     if (!parse_wildcard_type(&__node_293))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_wildcard_type, "wildcard_type");
                                       }
                                     (*yynode)->wildcard_type = __node_293;
                                   }
                                 else
                                   {
                                     return false;
                             ...
                             *yynode = create<type_argument_type_ast>();
                             ...
                             if (yytoken == Token_BOOLEAN
                                 ...
                                 || yytoken == Token_IDENTIFIER)
                               {
                                 if (yytoken == Token_IDENTIFIER)
                                   {
                                     class_type_ast *__node_294 = 0;
                                     if (!parse_class_type(&__node_294))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_class_type, "class_type");
                                       }
                                     (*yynode)->class_type = __node_294;
                                   }
                                 else if (yytoken == Token_BOOLEAN
                                          || yytoken == Token_BYTE
                                          || yytoken == Token_CHAR
                                          ...
                                          || yytoken == Token_VOID)
                                   {
                                     mandatory_array_builtin_type_ast *__node_295 = 0;
                                     if (!parse_mandatory_array_builtin_type(&__node_295))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_mandatory_array_builtin_type, "mandatory_array_builtin_type");
                                       }
                                     (*yynode)->mandatory_array_builtin_type = __node_295;
                                   }
                                 else
                                   {
                                     return false;
                             ...
                             if (yytoken == Token_LESS_THAN)
                               {
                                 ...
                                 int currentLtLevel = ltCounter;
                                 ltCounter++;
                                 type_argument_ast *__node_296 = 0;
                                 if (!parse_type_argument(&__node_296))
                                   {
                                     return yy_expected_symbol(ast_node::Kind_type_argument, "type_argument");
                                   }
                                 (*yynode)->type_argument_sequence = snoc((*yynode)->type_argument_sequence, __node_296, memory_pool);
                                 while (yytoken == Token_COMMA)
                                   {
                                     if ( ltCounter != currentLtLevel + 1 )
                                       {
                                     ...
                                     if (yytoken != Token_COMMA)
                                       return yy_expected_token(yytoken, Token_COMMA, ",");
                                     yylex();
                                     type_argument_ast *__node_297 = 0;
                                     if (!parse_type_argument(&__node_297))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_type_argument, "type_argument");
                                       }
                                     (*yynode)->type_argument_sequence = snoc((*yynode)->type_argument_sequence, __node_297, memory_pool);
                                   }
                                 if (yytoken == Token_GREATER_THAN
                                     || yytoken == Token_SIGNED_RSHIFT
                                     || yytoken == Token_UNSIGNED_RSHIFT)
                                   {
                                     type_arguments_or_parameters_end_ast *__node_298 = 0;
                                     if (!parse_type_arguments_or_parameters_end(&__node_298))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_type_arguments_or_parameters_end, "type_arguments_or_parameters_end");
                                       }
                                   }
                             ...
                             if (yytoken == Token_ABSTRACT
                                 ...
                                 || yytoken == Token_AT)
                               {
                                 ...
                                 if (yytoken == Token_ABSTRACT
                                     ...
                                     || yytoken == Token_AT)
                                   {
                                     optional_modifiers_ast *__node_299 = 0;
                                     if (!parse_optional_modifiers(&__node_299))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_optional_modifiers, "optional_modifiers");
                                       }
                                     modifiers = __node_299;
                                     if (yytoken == Token_CLASS)
                                       {
                                         class_declaration_ast *__node_300 = 0;
                                         if (!parse_class_declaration(&__node_300, modifiers))
                                           {
                                             return yy_expected_symbol(ast_node::Kind_class_declaration, "class_declaration");
                                           }
                                         (*yynode)->class_declaration = __node_300;
                                       }
                                     else if (yytoken == Token_ENUM)
                                       {
                                         enum_declaration_ast *__node_301 = 0;
                                         if (!parse_enum_declaration(&__node_301, modifiers))
                                           {
                                             return yy_expected_symbol(ast_node::Kind_enum_declaration, "enum_declaration");
                                           }
                                         (*yynode)->enum_declaration = __node_301;
                                       }
                                     else if (yytoken == Token_INTERFACE)
                                       {
                                         interface_declaration_ast *__node_302 = 0;
                                         if (!parse_interface_declaration(&__node_302, modifiers))
                                           {
                                             return yy_expected_symbol(ast_node::Kind_interface_declaration, "interface_declaration");
                                           }
                                         (*yynode)->interface_declaration = __node_302;
                                       }
                                     else if (yytoken == Token_AT)
                                       {
                                         annotation_type_declaration_ast *__node_303 = 0;
                                         if (!parse_annotation_type_declaration(&__node_303, modifiers))
                                           {
                                             return yy_expected_symbol(ast_node::Kind_annotation_type_declaration, "annotation_type_declaration");
                                           }
                                         (*yynode)->annotation_type_declaration = __node_303;
                                       }
                                     else
                                       {
                                         return false;
                                 ...
                                 if (yytoken == Token_EXTENDS)
                                   {
                                     if (yytoken != Token_EXTENDS)
                                       return yy_expected_token(yytoken, Token_EXTENDS, "extends");
                                     yylex();
                                     class_or_interface_type_name_ast *__node_305 = 0;
                                     if (!parse_class_or_interface_type_name(&__node_305))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_class_or_interface_type_name, "class_or_interface_type_name");
                                       }
                                     (*yynode)->extends_type_sequence = snoc((*yynode)->extends_type_sequence, __node_305, memory_pool);
                                     while (yytoken == Token_BIT_AND)
                                       {
                                         if (yytoken != Token_BIT_AND)
                                           return yy_expected_token(yytoken, Token_BIT_AND, "&");
                                         yylex();
                                         class_or_interface_type_name_ast *__node_306 = 0;
                                         if (!parse_class_or_interface_type_name(&__node_306))
                                           {
                                             return yy_expected_symbol(ast_node::Kind_class_or_interface_type_name, "class_or_interface_type_name");
                                           }
                                         (*yynode)->extends_type_sequence = snoc((*yynode)->extends_type_sequence, __node_306, memory_pool);
                                       }
                                   }
                                 else if (true /*epsilon*/)
                                 {}
                             ...
                             if (yytoken == Token_LESS_THAN)
                               {
                                 ...
                                 int currentLtLevel = ltCounter;
                                 ltCounter++;
                                 type_parameter_ast *__node_307 = 0;
                                 if (!parse_type_parameter(&__node_307))
                                   {
                                     return yy_expected_symbol(ast_node::Kind_type_parameter, "type_parameter");
                                   }
                                 (*yynode)->type_parameter_sequence = snoc((*yynode)->type_parameter_sequence, __node_307, memory_pool);
                                 while (yytoken == Token_COMMA)
                                   {
                                     if (yytoken != Token_COMMA)
                                       return yy_expected_token(yytoken, Token_COMMA, ",");
                                     yylex();
                                     type_parameter_ast *__node_308 = 0;
                                     if (!parse_type_parameter(&__node_308))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_type_parameter, "type_parameter");
                                       }
                                     (*yynode)->type_parameter_sequence = snoc((*yynode)->type_parameter_sequence, __node_308, memory_pool);
                                   }
                                 if (yytoken == Token_GREATER_THAN
                                     || yytoken == Token_SIGNED_RSHIFT
                                     || yytoken == Token_UNSIGNED_RSHIFT)
                                   {
                                     type_arguments_or_parameters_end_ast *__node_309 = 0;
                                     if (!parse_type_arguments_or_parameters_end(&__node_309))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_type_arguments_or_parameters_end, "type_arguments_or_parameters_end");
                                       }
                                   }
                                 ...
                                 if (yytoken == Token_INCREMENT)
                                   {
                                     if (yytoken != Token_INCREMENT)
                                       return yy_expected_token(yytoken, Token_INCREMENT, "++");
                                     yylex();
                                     unary_expression_ast *__node_310 = 0;
                                     if (!parse_unary_expression(&__node_310))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_unary_expression, "unary_expression");
                                       }
                                     (*yynode)->unary_expression = __node_310;
                                 ...
                                 else if (yytoken == Token_DECREMENT)
                                   {
                                     if (yytoken != Token_DECREMENT)
                                       return yy_expected_token(yytoken, Token_DECREMENT, "--");
                                     yylex();
                                     unary_expression_ast *__node_311 = 0;
                                     if (!parse_unary_expression(&__node_311))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_unary_expression, "unary_expression");
                                       }
                                     (*yynode)->unary_expression = __node_311;
                                 ...
                                 else if (yytoken == Token_MINUS)
                                   {
                                     if (yytoken != Token_MINUS)
                                       return yy_expected_token(yytoken, Token_MINUS, "-");
                                     yylex();
                                     unary_expression_ast *__node_312 = 0;
                                     if (!parse_unary_expression(&__node_312))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_unary_expression, "unary_expression");
                                       }
                                     (*yynode)->unary_expression = __node_312;
                                 ...
                                 else if (yytoken == Token_PLUS)
                                   {
                                     if (yytoken != Token_PLUS)
                                       return yy_expected_token(yytoken, Token_PLUS, "+");
                                     yylex();
                                     unary_expression_ast *__node_313 = 0;
                                     if (!parse_unary_expression(&__node_313))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_unary_expression, "unary_expression");
                                       }
                                     (*yynode)->unary_expression = __node_313;
                                     (*yynode)->rule_type = unary_expression::type_unary_plus_expression;
                                          ...
                                          || yytoken == Token_IDENTIFIER)
                                   {
                                     unary_expression_not_plusminus_ast *__node_314 = 0;
                                     if (!parse_unary_expression_not_plusminus(&__node_314))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_unary_expression_not_plusminus, "unary_expression_not_plusminus");
                                       }
                                     (*yynode)->unary_expression_not_plusminus = __node_314;
                                 ...
                                 if (yytoken == Token_TILDE)
                                   {
                                     ...
                                     yylex();
                                     unary_expression_ast *__node_315 = 0;
                                     if (!parse_unary_expression(&__node_315))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_unary_expression, "unary_expression");
                                       }
                                     (*yynode)->bitwise_not_expression = __node_315;
                                 ...
                                 else if (yytoken == Token_BANG)
                                   {
                                     ...
                                     yylex();
                                     unary_expression_ast *__node_316 = 0;
                                     if (!parse_unary_expression(&__node_316))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_unary_expression, "unary_expression");
                                       }
                                     (*yynode)->logical_not_expression = __node_316;
                                   ...
                                   {
                                     cast_expression_ast *__node_317 = 0;
                                     if (!parse_cast_expression(&__node_317))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_cast_expression, "cast_expression");
                                       }
                                     (*yynode)->cast_expression = __node_317;
                                     (*yynode)->rule_type = unary_expression_not_plusminus::type_cast_expression;
                                          ...
                                          || yytoken == Token_IDENTIFIER)
                                   {
                                     primary_expression_ast *__node_318 = 0;
                                     if (!parse_primary_expression(&__node_318))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_primary_expression, "primary_expression");
                                       }
                                     (*yynode)->primary_expression = __node_318;
                                     while (yytoken == Token_INCREMENT
                                            || yytoken == Token_DECREMENT)
                                       {
                                         postfix_operator_ast *__node_319 = 0;
                                         if (!parse_postfix_operator(&__node_319))
                                           {
                                             return yy_expected_symbol(ast_node::Kind_postfix_operator, "postfix_operator");
                                           }
                                         (*yynode)->postfix_operator_sequence = snoc((*yynode)->postfix_operator_sequence, __node_319, memory_pool);
                                       }
                             ...
                             if (yytoken == Token_LBRACE)
                               {
                                 ...
                                 if (yytoken == Token_BOOLEAN
                                     ...
                                     || yytoken == Token_IDENTIFIER)
                                   {
                                     variable_initializer_ast *__node_320 = 0;
                                     if (!parse_variable_initializer(&__node_320))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_variable_initializer, "variable_initializer");
                                       }
                                     (*yynode)->variable_initializer_sequence = snoc((*yynode)->variable_initializer_sequence, __node_320, memory_pool);
                                     while (yytoken == Token_COMMA)
                                       {
                                         if (LA(2).kind == Token_RBRACE)
                                           {
                                         ...
                                         if (yytoken != Token_COMMA)
                                           return yy_expected_token(yytoken, Token_COMMA, ",");
                                         yylex();
                                         variable_initializer_ast *__node_321 = 0;
                                         if (!parse_variable_initializer(&__node_321))
                                           {
                                             return yy_expected_symbol(ast_node::Kind_variable_initializer, "variable_initializer");
                                           }
                                         (*yynode)->variable_initializer_sequence = snoc((*yynode)->variable_initializer_sequence, __node_321, memory_pool);
                                       }
                                     if (yytoken == Token_COMMA)
                                       {
                                         if (yytoken != Token_COMMA)
                             ...
                             *yynode = create<variable_declaration_ast>();
                             ...
                             if (yytoken == Token_ABSTRACT
                                 ...
                                 || yytoken == Token_IDENTIFIER)
                               {
                                 ...
                                 optional_modifiers_ast *__node_322 = 0;
                                 if (!parse_optional_modifiers(&__node_322))
                                   {
                                     return yy_expected_symbol(ast_node::Kind_optional_modifiers, "optional_modifiers");
                                   }
                                 modifiers = __node_322;
                                 type_ast *__node_323 = 0;
                                 if (!parse_type(&__node_323))
                                   {
                                     return yy_expected_symbol(ast_node::Kind_type, "type");
                                   }
                                 type = __node_323;
                                 variable_declarator_ast *__node_324 = 0;
                                 if (!parse_variable_declarator(&__node_324))
                                   {
                                     return yy_expected_symbol(ast_node::Kind_variable_declarator, "variable_declarator");
                                   }
                                 variable_declarator_sequence = snoc(variable_declarator_sequence, __node_324, memory_pool);
                                 while (yytoken == Token_COMMA)
                                   {
                                     if (yytoken != Token_COMMA)
                                       return yy_expected_token(yytoken, Token_COMMA, ",");
                                     yylex();
                                     variable_declarator_ast *__node_325 = 0;
                                     if (!parse_variable_declarator(&__node_325))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_variable_declarator, "variable_declarator");
                                       }
                                     variable_declarator_sequence = snoc(variable_declarator_sequence, __node_325, memory_pool);
                                   }
                                 variable_declaration_data_ast *__node_326 = 0;
                                 if (!parse_variable_declaration_data(&__node_326,
                                                                      modifiers, type, variable_declarator_sequence
                                                                     ))
                                   {
                                     return yy_expected_symbol(ast_node::Kind_variable_declaration_data, "variable_declaration_data");
                                   }
                                 (*yynode)->data = __node_326;
                               }
                             else
                               {
                                 return false;
                                 ...
                                 if (yytoken == Token_ASSIGN)
                                   {
                                     if (yytoken != Token_ASSIGN)
                                       return yy_expected_token(yytoken, Token_ASSIGN, "=");
                                     yylex();
                                     variable_initializer_ast *__node_327 = 0;
                                     if (!parse_variable_initializer(&__node_327))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_variable_initializer, "variable_initializer");
                                       }
                                     (*yynode)->first_initializer = __node_327;
                                   }
                                 else if (true /*epsilon*/)
                                 {}
                                 else
                                 ...
                                 while (yytoken == Token_COMMA)
                                   {
                                     if (yytoken != Token_COMMA)
                                       return yy_expected_token(yytoken, Token_COMMA, ",");
                                     yylex();
                                     variable_declarator_ast *__node_328 = 0;
                                     if (!parse_variable_declarator(&__node_328))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_variable_declarator, "variable_declarator");
                                       }
                                     (*yynode)->variable_declarator_sequence = snoc((*yynode)->variable_declarator_sequence, __node_328, memory_pool);
                                   }
                               }
                             else
                               {
                             ...
                             *yynode = create<variable_declaration_split_data_ast>();
                             ...
                             if (true /*epsilon*/ || yytoken == Token_LBRACE
                                 || yytoken == Token_SEMICOLON)
                               {
                                 ...
                                 variable_declaration_data_ast *__node_329 = 0;
                                 if (!parse_variable_declaration_data(&__node_329,
                                 ...
                                 if (__node_329->start_token < (*yynode)->start_token)
                                   (*yynode)->start_token = __node_329->start_token;
                                 (*yynode)->data = __node_329;
                               }
                             else
                               {
                                 return false;
                             ...
                             if (yytoken == Token_IDENTIFIER)
                               {
                                 ...
                                 (*yynode)->variable_name = __node_330;
                                 optional_declarator_brackets_ast *__node_331 = 0;
                                 if (!parse_optional_declarator_brackets(&__node_331))
                                   {
                                     return yy_expected_symbol(ast_node::Kind_optional_declarator_brackets, "optional_declarator_brackets");
                                   }
                                 (*yynode)->declarator_brackets = __node_331;
                                 if (yytoken == Token_ASSIGN)
                                   {
                                     if (yytoken != Token_ASSIGN)
                                       return yy_expected_token(yytoken, Token_ASSIGN, "=");
                                     yylex();
                                     variable_initializer_ast *__node_332 = 0;
                                     if (!parse_variable_initializer(&__node_332))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_variable_initializer, "variable_initializer");
                                       }
                                     (*yynode)->initializer = __node_332;
                                   }
                                 else if (true /*epsilon*/)
                                 {}
                                 else
                             ...
                             if (yytoken == Token_BOOLEAN
                                 ...
                                 || yytoken == Token_IDENTIFIER)
                               {
                                 if (yytoken == Token_BOOLEAN
                                     ...
                                     || yytoken == Token_IDENTIFIER)
                                   {
                                     expression_ast *__node_333 = 0;
                                     if (!parse_expression(&__node_333))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_expression, "expression");
                                       }
                                   ...
                                   {
                                     variable_array_initializer_ast *__node_334 = 0;
                                     if (!parse_variable_array_initializer(&__node_334))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_variable_array_initializer, "variable_array_initializer");
                                       }
                                     (*yynode)->array_initializer = __node_334;
                                   }
                                 else
                                   {
                                     return false;
                             ...
                             if (yytoken == Token_WHILE)
                               {
                                 ...
                                 (*yynode)->condition = __node_335;
                                 if (yytoken != Token_RPAREN)
                                   return yy_expected_token(yytoken, Token_RPAREN, ")");
                                 yylex();
                                 embedded_statement_ast *__node_336 = 0;
                                 if (!parse_embedded_statement(&__node_336))
                                   {
                                     return yy_expected_symbol(ast_node::Kind_embedded_statement, "embedded_statement");
                                   }
                                 (*yynode)->body = __node_336;
                               }
                             else
                               {
                                 return false;
                             ...
                             if (yytoken == Token_QUESTION)
                               {
                                 ...
                                 if (yytoken == Token_EXTENDS
                                     || yytoken == Token_SUPER)
                                   {
                                     wildcard_type_bounds_ast *__node_337 = 0;
                                     if (!parse_wildcard_type_bounds(&__node_337))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_wildcard_type_bounds, "wildcard_type_bounds");
                                       }
                                     (*yynode)->bounds = __node_337;
                                   }
                                 else if (true /*epsilon*/)
                                 {}
                                 else
                             ...
                             *yynode = create<wildcard_type_bounds_ast>();
                             ...
                             if (yytoken == Token_EXTENDS
                                 || yytoken == Token_SUPER)
                               {
                                 ...
                                 class_type_ast *__node_338 = 0;
                                 if (!parse_class_type(&__node_338))
                                   {
                                     return yy_expected_symbol(ast_node::Kind_class_type, "class_type");
                                   }
                           ...
                           visitor::parser_fun_t visitor::_S_parser_table[] = {
                                 ...
                                 reinterpret_cast<parser_fun_t>(&visitor::visit_qualified_identifier_safe),
