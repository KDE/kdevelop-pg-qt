...
struct pp_and_expression_ast: public csharp_pp_ast_node
  {
    enum
    {
...
struct pp_equality_expression_ast: public csharp_pp_ast_node
  {
    enum
    {
...
class csharp_pp_visitor
  {
    typedef void (csharp_pp_visitor::*parser_fun_t)(csharp_pp_ast_node *);
    static parser_fun_t _S_parser_table[];

  public:
    virtual ~csharp_pp_visitor()
    {}
    virtual void visit_node(csharp_pp_ast_node *node)
    {
      if (node)
...
;
class csharp_pp_default_visitor: public csharp_pp_visitor
  {
  public:
