...
#define BASECLASS _ScopeModelItem
  ...
  UsingNamespaceDirectiveList _NamespaceDeclarationModelItem::usingNamespaces() const
    {
      return  _M_usingNamespaces.values();
    }

  void _NamespaceDeclarationModelItem::addUsingNamespace(UsingNamespaceDirectiveModelItem item)
  {
    if  ( _M_usingNamespaces.contains(item->namespaceUsed()) )
      removeUsingNamespace(_M_usingNamespaces[item->namespaceUsed()]);

    model()->beginAppendItem(item,  this);
    _M_usingNamespaces.insertMulti(item->namespaceUsed(),  item);
    model()->endAppendItem();
  }
  ...
  {
    model()->beginRemoveItem(item);
    _M_usingNamespaces.remove(item->namespaceUsed());
    model()->endRemoveItem();
  }

  UsingNamespaceDirectiveModelItem _NamespaceDeclarationModelItem::findUsingNamespace(const QStringList &namespaceUsed) const
    {
      return  _M_usingNamespaces.value(namespaceUsed);
    }
...
#define BASECLASS _ScopeModelItem
  ...
  _TypeDeclarationModelItem::_TypeDeclarationModelItem(CodeModel *model,  int kind)
      :  _ScopeModelItem(model,  kind)
      ,  _M_accessPolicy( access_policy::private )
      ,  _M_isNew( false )
  {}
...
#define BASECLASS _OperatorDeclarationModelItem
          ...
          TypeInfo _UnaryOperatorDeclarationModelItem::returnType() const
              ...
              overloadable_operator::overloadable_operator_enum _UnaryOperatorDeclarationModelItem::operator() const
                {
                  return _M_operator;
                }

              void _UnaryOperatorDeclarationModelItem::setOperator(overloadable_operator::overloadable_operator_enum operator)
              {
                _M_operator = operator;
              }
...
#define BASECLASS _OperatorDeclarationModelItem
              ...
              TypeInfo _BinaryOperatorDeclarationModelItem::returnType() const
                  ...
                  overloadable_operator::overloadable_operator_enum _BinaryOperatorDeclarationModelItem::operator() const
                    {
                      return _M_operator;
                    }

                  void _BinaryOperatorDeclarationModelItem::setOperator(overloadable_operator::overloadable_operator_enum operator)
                  {
                    _M_operator = operator;
                  }
...
#define BASECLASS _CodeModelItem
                  ...
                  _ParameterModelItem::_ParameterModelItem(CodeModel *model,  int kind)
                      :  _CodeModelItem(model,  kind)
                      ,  _M_isArray( false )
                      ,  _M_parameterType( parameter_type::value_parameter )
                  {}
                  ...
                  parameter_type::parameter_type_enum _ParameterModelItem::parameterType() const
                    {
                      return  _M_parameterType;
                    }

                  void _ParameterModelItem::setParameterType(parameter_type::parameter_type_enum parameterType)
                  {
...
#define BASECLASS _TypeParameterConstraintModelItem
                  ...
                  Type _PrimaryOrSecondaryConstraintModelItem::typeOrParameterName() const
                    {
                      return  _M_typeOrParameterName;
                    }

                  void _PrimaryOrSecondaryConstraintModelItem::setTypeOrParameterName(Type typeOrParameterName)
                  {
