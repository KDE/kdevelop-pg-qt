        ...
        while (yytoken == Token_IDENTIFIER)
          {
            ...
            if (!parse_case_condition(&__node_5))
              {
                return yy_expected_symbol(ast_node::Kind_case_condition, "case_condition");
              }
        ...
        while (yytoken == Token_IDENTIFIER)
          {
            ...
            if (!parse_feature(&__node_6))
              {
                return yy_expected_symbol(ast_node::Kind_feature, "feature");
              }
        ...
        if ((yytoken == Token_IDENTIFIER) && ( LA(2).kind == Token_LPAREN ))
            ...
            if (yytoken == Token_IDENTIFIER)
              {
                ...
                if (!parse_formal(&__node_8))
                  {
                    return yy_expected_symbol(ast_node::Kind_formal, "formal");
                  }
        ...
        else if (yytoken == Token_IDENTIFIER)
          {
            ...
            if (yytoken == Token_ARROW_LEFT)
              {
                if (yytoken != Token_ARROW_LEFT)
                  return yy_expected_token(yytoken, Token_ARROW_LEFT, "<-");
                yylex();
    ...
    if (yytoken == Token_LET)
      {
        ...
        if (!parse_let_declaration(&__node_16))
          {
            return yy_expected_symbol(ast_node::Kind_let_declaration, "let_declaration");
          }
    ...
    if (yytoken == Token_NEW
        ...
        || yytoken == Token_FALSE)
      {
        ...
        if (!parse_postfix_expression(&__node_19))
          {
            return yy_expected_symbol(ast_node::Kind_postfix_expression, "postfix_expression");
          }
        ...
        if ((yytoken == Token_IDENTIFIER) && ( LA(2).kind == Token_ARROW_LEFT ))
        ...
        else if (yytoken == Token_IF)
          {
            ...
            if (!parse_if_expression(&__node_30))
              {
                return yy_expected_symbol(ast_node::Kind_if_expression, "if_expression");
              }
        ...
        else if (yytoken == Token_WHILE)
          {
            ...
            if (!parse_while_expression(&__node_31))
              {
                return yy_expected_symbol(ast_node::Kind_while_expression, "while_expression");
              }
        ...
        else if (yytoken == Token_LBRACE)
          {
            ...
            if (!parse_block_expression(&__node_32))
              {
                return yy_expected_symbol(ast_node::Kind_block_expression, "block_expression");
              }
        ...
        else if (yytoken == Token_LET)
          {
            ...
            if (!parse_let_expression(&__node_33))
              {
                return yy_expected_symbol(ast_node::Kind_let_expression, "let_expression");
              }
        ...
        else if (yytoken == Token_CASE)
          {
            ...
            if (!parse_case_expression(&__node_34))
              {
                return yy_expected_symbol(ast_node::Kind_case_expression, "case_expression");
              }
        ...
        while (yytoken == Token_CLASS)
          {
            ...
            if (!parse_class(&__node_35))
              {
                return yy_expected_symbol(ast_node::Kind_class, "class");
              }
