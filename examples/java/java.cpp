...
namespace java
  ...
  bool parser::parse_annotation_type_declaration(annotation_type_declaration_ast **yynode)
  {
                ...
                if ((yytoken == Token_IDENTIFIER) && ( LA(2).kind == Token_LPAREN ))
                  {
                    ...
                    if (!parse_parameter_declaration_list(&__node_72))
                      {
                        return yy_expected_symbol(ast_node::Kind_parameter_declaration_list, "parameter_declaration_list");
                      }
  ...
  bool parser::parse_parameter_declaration_list(parameter_declaration_list_ast **yynode)
  {
  ...
  bool parser::parse_return_statement(return_statement_ast **yynode)
                           ...
                           visitor::parser_fun_t visitor::_S_parser_table[] = {
                                 ...
                                 reinterpret_cast<parser_fun_t>(&visitor::visit_parameter_declaration_list),
