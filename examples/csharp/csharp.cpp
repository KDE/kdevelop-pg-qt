    ...
    if (yytoken == Token_BOOL
        ...
        || yytoken == Token_IDENTIFIER)
      {
        ...
        if (yytoken == Token_BOOL
            ...
            || yytoken == Token_IDENTIFIER)
          {
            managed_type_ast *__node_300 = 0;
            if (!parse_managed_type(&__node_300))
              {
    ...
    *yynode = create<positional_argument_ast>();
    ...
    if (yytoken == Token_BASE
        ...
        || yytoken == Token_IDENTIFIER)
      {
        ...
        (*yynode)->attribute_argument_expression = __node_301;
      }
    else
      {
        return false;
    ...
    if (yytoken == Token_BASE
        ...
        || yytoken == Token_IDENTIFIER)
      {
        if (yytoken == Token_TRUE
            ...
            || yytoken == Token_STRING_LITERAL)
          {
            literal_ast *__node_302 = 0;
            if (!parse_literal(&__node_302))
              {
                return yy_expected_symbol(ast_node::Kind_literal, "literal");
              }
            (*yynode)->literal = __node_302;
        ...
        else if (yytoken == Token_LPAREN)
          {
            ...
            (*yynode)->rule_type = primary_atom::type_parenthesized_expression;
                 ...
                 || yytoken == Token_IDENTIFIER)
          {
            simple_name_or_member_access_ast *__node_304 = 0;
            if (!parse_simple_name_or_member_access(&__node_304))
              {
                return yy_expected_symbol(ast_node::Kind_simple_name_or_member_access, "simple_name_or_member_access");
              }
            (*yynode)->simple_name_or_member_access = __node_304;
        ...
        else if (yytoken == Token_DEFAULT)
          {
            ...
            if (yytoken != Token_LPAREN)
              return yy_expected_token(yytoken, Token_LPAREN, "(");
            yylex();
            type_ast *__node_310 = 0;
            if (!parse_type(&__node_310))
              {
                return yy_expected_symbol(ast_node::Kind_type, "type");
              }
          ...
          {
            anonymous_method_expression_ast *__node_311 = 0;
            if (!parse_anonymous_method_expression(&__node_311))
              {
                return yy_expected_symbol(ast_node::Kind_anonymous_method_expression, "anonymous_method_expression");
              }
            (*yynode)->anonymous_method_expression = __node_311;
        ...
        else if (yytoken == Token_SIZEOF)
          {
            ...
            if (yytoken != Token_LPAREN)
              return yy_expected_token(yytoken, Token_LPAREN, "(");
            yylex();
            unmanaged_type_ast *__node_312 = 0;
            if (!parse_unmanaged_type(&__node_312))
              {
                return yy_expected_symbol(ast_node::Kind_unmanaged_type, "unmanaged_type");
              }
            (*yynode)->unmanaged_type = __node_312;
            if (yytoken != Token_RPAREN)
              return yy_expected_token(yytoken, Token_RPAREN, ")");
            yylex();
  ...
  bool parser::parse_primary_expression(primary_expression_ast **yynode)
  {
    *yynode = create<primary_expression_ast>();
    ...
    if (yytoken == Token_BASE
        ...
        || yytoken == Token_IDENTIFIER)
      {
        primary_atom_ast *__node_313 = 0;
        if (!parse_primary_atom(&__node_313))
          {
            return yy_expected_symbol(ast_node::Kind_primary_atom, "primary_atom");
          }
        (*yynode)->primary_atom = __node_313;
        while (yytoken == Token_LPAREN
               ...
               || yytoken == Token_DECREMENT)
          {
            primary_suffix_ast *__node_314 = 0;
            if (!parse_primary_suffix(&__node_314))
              {
                return yy_expected_symbol(ast_node::Kind_primary_suffix, "primary_suffix");
              }
            (*yynode)->primary_suffix_sequence = snoc((*yynode)->primary_suffix_sequence, __node_314, memory_pool);
          }
      }
    else
      {
    ...
    if (yytoken == Token_CLASS
        ...
        || yytoken == Token_IDENTIFIER)
      {
        if (yytoken == Token_OBJECT
            ...
            || yytoken == Token_IDENTIFIER)
          {
            class_type_ast *__node_315 = 0;
            if (!parse_class_type(&__node_315))
              {
                return yy_expected_symbol(ast_node::Kind_class_type, "class_type");
              }
            (*yynode)->class_type_or_secondary_constraint = __node_315;
        ...
        if (yytoken == Token_DOT)
          {
            if (yytoken != Token_DOT)
              return yy_expected_token(yytoken, Token_DOT, ".");
            yylex();
            identifier_ast *__node_316 = 0;
            if (!parse_identifier(&__node_316))
              {
                return yy_expected_symbol(ast_node::Kind_identifier, "identifier");
              }
            (*yynode)->member_name = __node_316;
            if ((yytoken == Token_LESS_THAN) && ( lookahead_is_type_arguments() == true ))
              {
                type_arguments_ast *__node_317 = 0;
                if (!parse_type_arguments(&__node_317))
                  {
                    return yy_expected_symbol(ast_node::Kind_type_arguments, "type_arguments");
                  }
                (*yynode)->type_arguments = __node_317;
              }
            else if (true /*epsilon*/)
            {}
            else
        ...
        else if (yytoken == Token_LPAREN)
          {
            if (yytoken != Token_LPAREN)
              return yy_expected_token(yytoken, Token_LPAREN, "(");
            yylex();
            optional_argument_list_ast *__node_318 = 0;
            if (!parse_optional_argument_list(&__node_318))
              {
                return yy_expected_symbol(ast_node::Kind_optional_argument_list, "optional_argument_list");
              }
            (*yynode)->arguments = __node_318;
            if (yytoken != Token_RPAREN)
              return yy_expected_token(yytoken, Token_RPAREN, ")");
            yylex();
            ...
            while (yytoken == Token_COMMA)
              {
                ...
                (*yynode)->expression_sequence = snoc((*yynode)->expression_sequence, __node_320, memory_pool);
              }
            if (yytoken != Token_RBRACKET)
              return yy_expected_token(yytoken, Token_RBRACKET, "]");
            yylex();
        ...
        else if (yytoken == Token_ARROW_RIGHT)
          {
            ...
            (*yynode)->member_name = __node_321;
            if ((yytoken == Token_LESS_THAN) && ( lookahead_is_type_arguments() == true ))
              {
                type_arguments_ast *__node_322 = 0;
                if (!parse_type_arguments(&__node_322))
                  {
                    return yy_expected_symbol(ast_node::Kind_type_arguments, "type_arguments");
                  }
                (*yynode)->type_arguments = __node_322;
              }
            else if (true /*epsilon*/)
            {}
            else
    ...
    if (yytoken == Token_LBRACE)
      {
        if (yytoken != Token_LBRACE)
          return yy_expected_token(yytoken, Token_LBRACE, "{");
        yylex();
        accessor_declarations_ast *__node_323 = 0;
        if (!parse_accessor_declarations(&__node_323))
          {
            return yy_expected_symbol(ast_node::Kind_accessor_declarations, "accessor_declarations");
          }
        (*yynode)->accessor_declarations = __node_323;
        if (yytoken != Token_RBRACE)
          return yy_expected_token(yytoken, Token_RBRACE, "}");
        yylex();
      }
  ...
  bool parser::parse_qualified_identifier(qualified_identifier_ast **yynode)
  {
    *yynode = create<qualified_identifier_ast>();
    ...
    if (yytoken == Token_ADD
        ...
        || yytoken == Token_IDENTIFIER)
      {
        identifier_ast *__node_324 = 0;
        if (!parse_identifier(&__node_324))
          {
            return yy_expected_symbol(ast_node::Kind_identifier, "identifier");
          }
        (*yynode)->name_sequence = snoc((*yynode)->name_sequence, __node_324, memory_pool);
        while (yytoken == Token_DOT)
          {
            if (yytoken != Token_DOT)
              return yy_expected_token(yytoken, Token_DOT, ".");
            ...
            (*yynode)->name_sequence = snoc((*yynode)->name_sequence, __node_325, memory_pool);
          }
      }
    else
      {
    ...
    if (yytoken == Token_BASE
        ...
        || yytoken == Token_IDENTIFIER)
      {
        ...
        while (yytoken == Token_AS
               ...
               || yytoken == Token_GREATER_EQUAL)
          {
            relational_expression_rest_ast *__node_327 = 0;
            if (!parse_relational_expression_rest(&__node_327))
              {
                return yy_expected_symbol(ast_node::Kind_relational_expression_rest, "relational_expression_rest");
              }
            (*yynode)->additional_expression_sequence = snoc((*yynode)->additional_expression_sequence, __node_327, memory_pool);
          }
      }
    else
      {
        ...
        || yytoken == Token_GREATER_EQUAL)
      {
        if (yytoken == Token_LESS_THAN
                 ...
                 || yytoken == Token_IS)
          {
            ...
            type_ast *__node_329 = 0;
            if (!parse_type(&__node_329))
              {
                return yy_expected_symbol(ast_node::Kind_type, "type");
              }
            (*yynode)->type = __node_329;
          }
        else
          {
            return false;
    ...
    if (yytoken == Token_BASE
        ...
        || yytoken == Token_IDENTIFIER)
      {
        if ((yytoken == Token_BOOL
             ...
             || yytoken == Token_IDENTIFIER) && ( lookahead_is_local_variable_declaration() == true ))
          {
            local_variable_declaration_ast *__node_330 = 0;
            if (!parse_local_variable_declaration(&__node_330))
              {
                return yy_expected_symbol(ast_node::Kind_local_variable_declaration, "local_variable_declaration");
              }
            (*yynode)->local_variable_declaration = __node_330;
          }
        else if (yytoken == Token_BASE
                 || yytoken == Token_BOOL
                 || yytoken == Token_BYTE
                 ...
                 || yytoken == Token_IDENTIFIER)
          {
            expression_ast *__node_331 = 0;
            if (!parse_expression(&__node_331))
              {
                return yy_expected_symbol(ast_node::Kind_expression, "expression");
              }
            (*yynode)->expression = __node_331;
          }
        else
          {
            return false;
                             ...
                             if (yytoken == Token_RETURN)
                               {
                                 ...
                                 if (yytoken == Token_BASE
                                     ...
                                     || yytoken == Token_IDENTIFIER)
                                   {
                                     expression_ast *__node_332 = 0;
                                     if (!parse_expression(&__node_332))
                                       {
                                         return yy_expected_symbol(ast_node::Kind_expression, "expression");
                                       }
                                     (*yynode)->return_expression = __node_332;
                                   }
                                 else if (true /*epsilon*/)
                                 {}
                                 else
                                                          ...
                                                          || yytoken == Token_IDENTIFIER)
                                                        {
                                                          if ((yytoken == Token_VOID) && ( LA(2).kind != Token_STAR ))
                                                                   ...
                                                                   || yytoken == Token_IDENTIFIER)
                                                            {
                                                              ...
                                                              (*yynode)->regular_type = __node_333;
                                                    ...
                                                    bool parser::parse_secondary_constraints(secondary_constraints_ast **yynode)
                                                    {
                                                      *yynode = create<secondary_constraints_ast>();
                                                      ...
                                                      if (yytoken == Token_ADD
                                                          ...
                                                          || yytoken == Token_IDENTIFIER)
                                                        {
                                                          type_name_ast *__node_334 = 0;
                                                          if (!parse_type_name(&__node_334))
                                                            {
                                                              return yy_expected_symbol(ast_node::Kind_type_name, "type_name");
                                                            }
                                                          (*yynode)->interface_type_or_type_parameter_sequence = snoc((*yynode)->interface_type_or_type_parameter_sequence, __node_334, memory_pool);
                                                          while (yytoken == Token_COMMA)
                                                            {
                                                              ...
                                                              if (yytoken != Token_COMMA)
                                                                return yy_expected_token(yytoken, Token_COMMA, ",");
                                                              yylex();
                                                              type_name_ast *__node_335 = 0;
                                                              if (!parse_type_name(&__node_335))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_type_name, "type_name");
                                                                }
                                                              (*yynode)->interface_type_or_type_parameter_sequence = snoc((*yynode)->interface_type_or_type_parameter_sequence, __node_335, memory_pool);
                                                            }
                                                        }
                                                      else
                                                        {
                                                      ...
                                                      if (yytoken == Token_BASE
                                                          ...
                                                          || yytoken == Token_IDENTIFIER)
                                                        {
                                                          ...
                                                          while (yytoken == Token_LSHIFT
                                                                 || yytoken == Token_RSHIFT)
                                                            {
                                                              shift_expression_rest_ast *__node_337 = 0;
                                                              if (!parse_shift_expression_rest(&__node_337))
                                                                {
                                                          ...
                                                          if (yytoken == Token_ADD
                                                              ...
                                                              || yytoken == Token_IDENTIFIER)
                                                            {
                                                              if ((yytoken == Token_ADD
                                                                   ...
                                                                   || yytoken == Token_IDENTIFIER) && ( LA(2).kind == Token_SCOPE ))
                                                                {
                                                                  identifier_ast *__node_339 = 0;
                                                                  if (!parse_identifier(&__node_339))
                                                                    {
                                                                      return yy_expected_symbol(ast_node::Kind_identifier, "identifier");
                                                                    }
                                                                  (*yynode)->qualified_alias_label = __node_339;
                                                                  if (yytoken != Token_SCOPE)
                                                                    return yy_expected_token(yytoken, Token_SCOPE, "::");
                                                                  yylex();
                                                                }
                                                              ...
                                                              {}
                                                              else
                                                                {
                                                                  return false;
                                                                   ...
                                                                   || yytoken == Token_USHORT)
                                                            {
                                                              predefined_type_ast *__node_342 = 0;
                                                              if (!parse_predefined_type(&__node_342))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_predefined_type, "predefined_type");
                                                                }
                                                              (*yynode)->predefined_type = __node_342;
                                                              if (yytoken != Token_DOT)
                                                                return yy_expected_token(yytoken, Token_DOT, ".");
                                                              yylex();
                                                              ...
                                                              (*yynode)->member_name = __node_343;
                                                              if ((yytoken == Token_LESS_THAN) && ( lookahead_is_type_arguments() == true ))
                                                                {
                                                                  type_arguments_ast *__node_344 = 0;
                                                                  if (!parse_type_arguments(&__node_344))
                                                                    {
                                                                      return yy_expected_symbol(ast_node::Kind_type_arguments, "type_arguments");
                                                                    }
                                                                  (*yynode)->type_arguments = __node_344;
                                                                }
                                                              else if (true /*epsilon*/)
                                                              {}
                                                              else
                                                      ...
                                                      if (yytoken == Token_BOOL
                                                          ...
                                                          || yytoken == Token_USHORT)
                                                        {
                                                          if (yytoken == Token_BYTE
                                                              ...
                                                              || yytoken == Token_USHORT)
                                                            {
                                                              numeric_type_ast *__node_345 = 0;
                                                              if (!parse_numeric_type(&__node_345))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_numeric_type, "numeric_type");
                                                                }
                                                              (*yynode)->numeric_type = __node_345;
                                                      ...
                                                      if (yytoken == Token_CATCH)
                                                        {
                                                          ...
                                                          if (yytoken != Token_LPAREN)
                                                            return yy_expected_token(yytoken, Token_LPAREN, "(");
                                                          yylex();
                                                          class_type_ast *__node_346 = 0;
                                                          if (!parse_class_type(&__node_346))
                                                            {
                                                              return yy_expected_symbol(ast_node::Kind_class_type, "class_type");
                                                            }
                                                          (*yynode)->exception_type = __node_346;
                                                          if (yytoken == Token_ADD
                                                              || yytoken == Token_ALIAS
                                                              || yytoken == Token_GET
                                                              || yytoken == Token_GLOBAL
                                                              ...
                                                              || yytoken == Token_IDENTIFIER)
                                                            {
                                                              ...
                                                              (*yynode)->exception_name = __node_347;
                                                            }
                                                          else if (true /*epsilon*/)
                                                          {}
                                                          else
                                                          ...
                                                          if (yytoken != Token_RPAREN)
                                                            return yy_expected_token(yytoken, Token_RPAREN, ")");
                                                          yylex();
                                                          block_ast *__node_348 = 0;
                                                          if (!parse_block(&__node_348))
                                                            {
                                                              return yy_expected_symbol(ast_node::Kind_block, "block");
                                                            }
                                                          (*yynode)->body = __node_348;
                                                        }
                                                      else
                                                        {
                                                          return false;
                                                      ...
                                                      if (yytoken == Token_STACKALLOC)
                                                        {
                                                          if (yytoken != Token_STACKALLOC)
                                                            return yy_expected_token(yytoken, Token_STACKALLOC, "stackalloc");
                                                          yylex();
                                                          unmanaged_type_ast *__node_349 = 0;
                                                          if (!parse_unmanaged_type(&__node_349))
                                                            {
                                                              return yy_expected_symbol(ast_node::Kind_unmanaged_type, "unmanaged_type");
                                                            }
                                                          if (yytoken != Token_LBRACKET)
                                                      ...
                                                      if (yytoken == Token_LBRACE)
                                                        {
                                                          ...
                                                          while (yytoken == Token_ABSTRACT
                                                                 ...
                                                                 || yytoken == Token_IDENTIFIER)
                                                            {
                                                              struct_member_declaration_ast *__node_352 = 0;
                                                              if (!parse_struct_member_declaration(&__node_352))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_struct_member_declaration, "struct_member_declaration");
                                                                }
                                                              (*yynode)->member_declaration_sequence = snoc((*yynode)->member_declaration_sequence, __node_352, memory_pool);
                                                            }
                                                          if (yytoken != Token_RBRACE)
                                                            return yy_expected_token(yytoken, Token_RBRACE, "}");
                                                          yylex();
                                                      ...
                                                      if (yytoken == Token_STRUCT)
                                                        {
                                                          ...
                                                          (*yynode)->struct_name = __node_353;
                                                          if ((yytoken == Token_LESS_THAN) && ( compatibility_mode() >= csharp20_compatibility ))
                                                            {
                                                              type_parameters_ast *__node_354 = 0;
                                                              if (!parse_type_parameters(&__node_354))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_type_parameters, "type_parameters");
                                                                }
                                                              (*yynode)->type_parameters = __node_354;
                                                            }
                                                          else if (true /*epsilon*/)
                                                          {}
                                                          else
                                                          ...
                                                          if (yytoken == Token_COLON)
                                                            {
                                                              struct_interfaces_ast *__node_355 = 0;
                                                              if (!parse_struct_interfaces(&__node_355))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_struct_interfaces, "struct_interfaces");
                                                                }
                                                              (*yynode)->struct_interfaces = __node_355;
                                                            }
                                                          else if (true /*epsilon*/)
                                                          {}
                                                          else
                                                          ...
                                                          if ((yytoken == Token_WHERE) && ( compatibility_mode() >= csharp20_compatibility ))
                                                            {
                                                              type_parameter_constraints_clauses_ast *__node_356 = 0;
                                                              if (!parse_type_parameter_constraints_clauses(&__node_356))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_type_parameter_constraints_clauses, "type_parameter_constraints_clauses");
                                                                }
                                                              (*yynode)->type_parameter_constraints_clauses = __node_356;
                                                            }
                                                          else if (true /*epsilon*/)
                                                          {}
                                                          else
                                                          ...
                                                          struct_body_ast *__node_357 = 0;
                                                          if (!parse_struct_body(&__node_357))
                                                            {
                                                      ...
                                                      if (yytoken == Token_COLON)
                                                        {
                                                          if (yytoken != Token_COLON)
                                                            return yy_expected_token(yytoken, Token_COLON, ":");
                                                          yylex();
                                                          type_name_ast *__node_358 = 0;
                                                          if (!parse_type_name(&__node_358))
                                                            {
                                                              return yy_expected_symbol(ast_node::Kind_type_name, "type_name");
                                                            }
                                                          (*yynode)->interface_type_sequence = snoc((*yynode)->interface_type_sequence, __node_358, memory_pool);
                                                          while (yytoken == Token_COMMA)
                                                            {
                                                              if (yytoken != Token_COMMA)
                                                                return yy_expected_token(yytoken, Token_COMMA, ",");
                                                              yylex();
                                                              type_name_ast *__node_359 = 0;
                                                              if (!parse_type_name(&__node_359))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_type_name, "type_name");
                                                                }
                                                              (*yynode)->interface_type_sequence = snoc((*yynode)->interface_type_sequence, __node_359, memory_pool);
                                                            }
                                                        }
                                                      else
                                                        {
                                                      ...
                                                      *yynode = create<struct_member_declaration_ast>();
                                                      ...
                                                      if (yytoken == Token_ABSTRACT
                                                          ...
                                                          || yytoken == Token_IDENTIFIER)
                                                        {
                                                          ...
                                                          while (yytoken == Token_LBRACKET)
                                                            {
                                                              attribute_section_ast *__node_360 = 0;
                                                              if (!parse_attribute_section(&__node_360))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_attribute_section, "attribute_section");
                                                                }
                                                              attribute_sequence = snoc(attribute_sequence, __node_360, memory_pool);
                                                            }
                                                          optional_modifiers_ast *__node_361 = 0;
                                                          if (!parse_optional_modifiers(&__node_361))
                                                            {
                                                              return yy_expected_symbol(ast_node::Kind_optional_modifiers, "optional_modifiers");
                                                            }
                                                          modifiers = __node_361;
                                                          class_or_struct_member_declaration_ast *__node_362 = 0;
                                                          if (!parse_class_or_struct_member_declaration(&__node_362, attribute_sequence, modifiers ))
                                                            {
                                                              return yy_expected_symbol(ast_node::Kind_class_or_struct_member_declaration, "class_or_struct_member_declaration");
                                                            }
                                                          (*yynode)->declaration = __node_362;
                                                        }
                                                      else
                                                        {
                                                          return false;
                                                          ...
                                                          if (yytoken == Token_CASE)
                                                            {
                                                              if (yytoken != Token_CASE)
                                                                return yy_expected_token(yytoken, Token_CASE, "case");
                                                              yylex();
                                                              constant_expression_ast *__node_363 = 0;
                                                              if (!parse_constant_expression(&__node_363))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_constant_expression, "constant_expression");
                                                                }
                                                              (*yynode)->case_expression = __node_363;
                                                      ...
                                                      *yynode = create<switch_section_ast>();
                                                      ...
                                                      if (yytoken == Token_CASE
                                                          || yytoken == Token_DEFAULT)
                                                        {
                                                          do
                                                            {
                                                              switch_label_ast *__node_364 = 0;
                                                              if (!parse_switch_label(&__node_364))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_switch_label, "switch_label");
                                                                }
                                                              (*yynode)->label_sequence = snoc((*yynode)->label_sequence, __node_364, memory_pool);
                                                            }
                                                          ...
                                                          do
                                                            {
                                                              ...
                                                              block_statement_ast *__node_365 = 0;
                                                              if (!parse_block_statement(&__node_365))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_block_statement, "block_statement");
                                                                }
                                                              (*yynode)->statement_sequence = snoc((*yynode)->statement_sequence, __node_365, memory_pool);
                                                            }
                                                          while (yytoken == Token_BASE
                                                                 || yytoken == Token_BOOL
                                                                 || yytoken == Token_BREAK
                                                      ...
                                                      if (yytoken == Token_SWITCH)
                                                        {
                                                          ...
                                                          (*yynode)->switch_expression = __node_366;
                                                          if (yytoken != Token_RPAREN)
                                                            return yy_expected_token(yytoken, Token_RPAREN, ")");
                                                          yylex();
                                                          if (yytoken != Token_LBRACE)
                                                          ...
                                                          while (yytoken == Token_CASE
                                                                 || yytoken == Token_DEFAULT)
                                                            {
                                                              switch_section_ast *__node_367 = 0;
                                                              if (!parse_switch_section(&__node_367))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_switch_section, "switch_section");
                                                                }
                                                              (*yynode)->switch_section_sequence = snoc((*yynode)->switch_section_sequence, __node_367, memory_pool);
                                                            }
                                                          if (yytoken != Token_RBRACE)
                                                            return yy_expected_token(yytoken, Token_RBRACE, "}");
                                                          yylex();
                                                      ...
                                                      if (yytoken == Token_TRY)
                                                        {
                                                          ...
                                                          (*yynode)->try_body = __node_369;
                                                          if (yytoken == Token_CATCH)
                                                            {
                                                              catch_clauses_ast *__node_370 = 0;
                                                              if (!parse_catch_clauses(&__node_370))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_catch_clauses, "catch_clauses");
                                                                }
                                                              (*yynode)->catch_clauses = __node_370;
                                                              if (yytoken == Token_FINALLY)
                                                                {
                                                                  if (yytoken != Token_FINALLY)
                                                                    return yy_expected_token(yytoken, Token_FINALLY, "finally");
                                                                  ...
                                                                  (*yynode)->finally_body = __node_371;
                                                                }
                                                              else if (true /*epsilon*/)
                                                              {}
                                                              else
                                                          ...
                                                          else if (yytoken == Token_FINALLY)
                                                            {
                                                              if (yytoken != Token_FINALLY)
                                                                return yy_expected_token(yytoken, Token_FINALLY, "finally");
                                                              yylex();
                                                              block_ast *__node_372 = 0;
                                                              if (!parse_block(&__node_372))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_block, "block");
                                                                }
                                                              (*yynode)->finally_body = __node_372;
                                                            }
                                                          else
                                                            {
                                                              return false;
                                                    ...
                                                    bool parser::parse_type(type_ast **yynode)
                                                    {
                                                      *yynode = create<type_ast>();
                                                      ...
                                                      if (yytoken == Token_BOOL
                                                          ...
                                                          || yytoken == Token_IDENTIFIER)
                                                        {
                                                          unmanaged_type_ast *__node_373 = 0;
                                                          if (!parse_unmanaged_type(&__node_373))
                                                            {
                                                              return yy_expected_symbol(ast_node::Kind_unmanaged_type, "unmanaged_type");
                                                            }
                                                          (*yynode)->unmanaged_type = __node_373;
                                                        }
                                                      else
                                                        {
                                                          return false;
                                                      ...
                                                      if (yytoken == Token_LESS_THAN)
                                                        {
                                                          ...
                                                          _M_ltCounter++;
                                                          type_ast *__node_374 = 0;
                                                          if (!parse_type(&__node_374))
                                                            {
                                                              return yy_expected_symbol(ast_node::Kind_type, "type");
                                                            }
                                                          (*yynode)->type_argument_sequence = snoc((*yynode)->type_argument_sequence, __node_374, memory_pool);
                                                          while (yytoken == Token_COMMA)
                                                            {
                                                              if (yytoken != Token_COMMA)
                                                                return yy_expected_token(yytoken, Token_COMMA, ",");
                                                              yylex();
                                                              type_ast *__node_375 = 0;
                                                              if (!parse_type(&__node_375))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_type, "type");
                                                                }
                                                              (*yynode)->type_argument_sequence = snoc((*yynode)->type_argument_sequence, __node_375, memory_pool);
                                                            }
                                                          if (yytoken == Token_GREATER_THAN
                                                              || yytoken == Token_RSHIFT)
                                                            {
                                                              type_arguments_or_parameters_end_ast *__node_376 = 0;
                                                              if (!parse_type_arguments_or_parameters_end(&__node_376))
                                                                {
                                                      ...
                                                      *yynode = create<type_declaration_ast>();
                                                      ...
                                                      if (yytoken == Token_ABSTRACT
                                                          ...
                                                          || yytoken == Token_LBRACKET)
                                                        {
                                                          ...
                                                          while (yytoken == Token_LBRACKET)
                                                            {
                                                              attribute_section_ast *__node_377 = 0;
                                                              if (!parse_attribute_section(&__node_377))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_attribute_section, "attribute_section");
                                                                }
                                                              attribute_sequence = snoc(attribute_sequence, __node_377, memory_pool);
                                                            }
                                                          optional_modifiers_ast *__node_378 = 0;
                                                          if (!parse_optional_modifiers(&__node_378))
                                                            {
                                                              return yy_expected_symbol(ast_node::Kind_optional_modifiers, "optional_modifiers");
                                                            }
                                                          modifiers = __node_378;
                                                          type_declaration_rest_ast *__node_379 = 0;
                                                          if (!parse_type_declaration_rest(&__node_379, attribute_sequence, modifiers ))
                                                            {
                                                              return yy_expected_symbol(ast_node::Kind_type_declaration_rest, "type_declaration_rest");
                                                            }
                                                          (*yynode)->rest = __node_379;
                                                        }
                                                      else
                                                        {
                                                          return false;
                                                      ...
                                                      if (yytoken == Token_CLASS
                                                          ...
                                                          || yytoken == Token_PARTIAL)
                                                        {
                                                          if (yytoken == Token_PARTIAL)
                                                              ...
                                                              if (yytoken == Token_CLASS)
                                                                {
                                                                  ...
                                                                  if (!parse_class_declaration(&__node_380, attribute_sequence, modifiers, true ))
                                                                    {
                                                              ...
                                                              else if (yytoken == Token_STRUCT)
                                                                {
                                                                  ...
                                                                  if (!parse_struct_declaration(&__node_381, attribute_sequence, modifiers, true ))
                                                                    {
                                                              ...
                                                              else if (yytoken == Token_INTERFACE)
                                                                {
                                                                  ...
                                                                  if (!parse_interface_declaration(&__node_382, attribute_sequence, modifiers, true ))
                                                                    {
                                                            ...
                                                            {
                                                              class_declaration_ast *__node_383 = 0;
                                                              if (!parse_class_declaration(&__node_383, attribute_sequence, modifiers, false ))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_class_declaration, "class_declaration");
                                                                }
                                                              if (__node_383->start_token < (*yynode)->start_token)
                                                                (*yynode)->start_token = __node_383->start_token;
                                                              (*yynode)->class_declaration = __node_383;
                                                            }
                                                          else if (yytoken == Token_STRUCT)
                                                            {
                                                              struct_declaration_ast *__node_384 = 0;
                                                              if (!parse_struct_declaration(&__node_384, attribute_sequence, modifiers, false ))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_struct_declaration, "struct_declaration");
                                                                }
                                                              if (__node_384->start_token < (*yynode)->start_token)
                                                                (*yynode)->start_token = __node_384->start_token;
                                                              (*yynode)->struct_declaration = __node_384;
                                                            }
                                                          else if (yytoken == Token_INTERFACE)
                                                            {
                                                              interface_declaration_ast *__node_385 = 0;
                                                              if (!parse_interface_declaration(&__node_385, attribute_sequence, modifiers, false ))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_interface_declaration, "interface_declaration");
                                                                }
                                                              if (__node_385->start_token < (*yynode)->start_token)
                                                                (*yynode)->start_token = __node_385->start_token;
                                                              (*yynode)->interface_declaration = __node_385;
                                                            }
                                                          else if (yytoken == Token_ENUM)
                                                            {
                                                              enum_declaration_ast *__node_386 = 0;
                                                              if (!parse_enum_declaration(&__node_386, attribute_sequence, modifiers ))
                                                                {
                                                              ...
                                                              (*yynode)->enum_declaration = __node_386;
                                                            }
                                                          else if (yytoken == Token_DELEGATE)
                                                            {
                                                              delegate_declaration_ast *__node_387 = 0;
                                                              if (!parse_delegate_declaration(&__node_387, attribute_sequence, modifiers ))
                                                                {
                                                              ...
                                                              (*yynode)->delegate_declaration = __node_387;
                                                            }
                                                          else
                                                            {
                                                              return false;
                                                    ...
                                                    bool parser::parse_type_name(type_name_ast **yynode)
                                                    {
                                                      *yynode = create<type_name_ast>();
                                                      ...
                                                      if (yytoken == Token_ADD
                                                          ...
                                                          || yytoken == Token_IDENTIFIER)
                                                        {
                                                          namespace_or_type_name_ast *__node_388 = 0;
                                                          if (!parse_namespace_or_type_name(&__node_388))
                                                            {
                                                              return yy_expected_symbol(ast_node::Kind_namespace_or_type_name, "namespace_or_type_name");
                                                            }
                                                        }
                                                    ...
                                                    bool parser::parse_type_name_safe(type_name_safe_ast **yynode)
                                                    {
                                                      *yynode = create<type_name_safe_ast>();
                                                      ...
                                                      if (yytoken == Token_ADD
                                                          ...
                                                          || yytoken == Token_IDENTIFIER)
                                                        {
                                                          namespace_or_type_name_safe_ast *__node_389 = 0;
                                                          if (!parse_namespace_or_type_name_safe(&__node_389))
                                                            {
                                                      ...
                                                      *yynode = create<type_parameter_ast>();
                                                      ...
                                                      if (yytoken == Token_ADD
                                                          ...
                                                          || yytoken == Token_IDENTIFIER)
                                                        {
                                                          while (yytoken == Token_LBRACKET)
                                                            {
                                                              attribute_section_ast *__node_390 = 0;
                                                              if (!parse_attribute_section(&__node_390))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_attribute_section, "attribute_section");
                                                                }
                                                              (*yynode)->attribute_sequence = snoc((*yynode)->attribute_sequence, __node_390, memory_pool);
                                                            }
                                                          identifier_ast *__node_391 = 0;
                                                          if (!parse_identifier(&__node_391))
                                                            {
                                                              return yy_expected_symbol(ast_node::Kind_identifier, "identifier");
                                                            }
                                                          (*yynode)->parameter_name = __node_391;
                                                        }
                                                      else
                                                        {
                                                          return false;
                                                      ...
                                                      if (yytoken == Token_CLASS
                                                          ...
                                                          || yytoken == Token_IDENTIFIER)
                                                        {
                                                          if (yytoken == Token_CLASS
                                                              ...
                                                              || yytoken == Token_IDENTIFIER)
                                                            {
                                                              primary_or_secondary_constraint_ast *__node_392 = 0;
                                                              if (!parse_primary_or_secondary_constraint(&__node_392))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_primary_or_secondary_constraint, "primary_or_secondary_constraint");
                                                                }
                                                              (*yynode)->primary_or_secondary_constraint = __node_392;
                                                              if (yytoken == Token_COMMA)
                                                                {
                                                                  if (yytoken != Token_COMMA)
                                                                    return yy_expected_token(yytoken, Token_COMMA, ",");
                                                              ...
                                                              {}
                                                              else
                                                                {
                                                                  return false;
                                                                   ...
                                                                   || yytoken == Token_IDENTIFIER)
                                                            {
                                                              secondary_constraints_ast *__node_396 = 0;
                                                              if (!parse_secondary_constraints(&__node_396))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_secondary_constraints, "secondary_constraints");
                                                                }
                                                              (*yynode)->secondary_constraints = __node_396;
                                                              if (yytoken == Token_COMMA)
                                                                {
                                                                  if (yytoken != Token_COMMA)
                                                                    return yy_expected_token(yytoken, Token_COMMA, ",");
                                                      ...
                                                      if (yytoken == Token_WHERE)
                                                        {
                                                          if (yytoken != Token_WHERE)
                                                            return yy_expected_token(yytoken, Token_WHERE, "where");
                                                          yylex();
                                                          identifier_ast *__node_399 = 0;
                                                          if (!parse_identifier(&__node_399))
                                                            {
                                                              return yy_expected_symbol(ast_node::Kind_identifier, "identifier");
                                                            }
                                                          (*yynode)->type_parameter = __node_399;
                                                          if (yytoken != Token_COLON)
                                                            return yy_expected_token(yytoken, Token_COLON, ":");
                                                          yylex();
                                                          type_parameter_constraints_ast *__node_400 = 0;
                                                          if (!parse_type_parameter_constraints(&__node_400))
                                                            {
                                                              return yy_expected_symbol(ast_node::Kind_type_parameter_constraints, "type_parameter_constraints");
                                                            }
                                                          (*yynode)->constraints = __node_400;
                                                        }
                                                      else
                                                        {
                                                          return false;
                                                      ...
                                                      if (yytoken == Token_WHERE)
                                                        {
                                                          do
                                                            {
                                                              type_parameter_constraints_clause_ast *__node_401 = 0;
                                                              if (!parse_type_parameter_constraints_clause(&__node_401))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_type_parameter_constraints_clause, "type_parameter_constraints_clause");
                                                                }
                                                              (*yynode)->clause_sequence = snoc((*yynode)->clause_sequence, __node_401, memory_pool);
                                                            }
                                                      ...
                                                      if (yytoken == Token_LESS_THAN)
                                                        {
                                                          ...
                                                          int currentLtLevel = _M_ltCounter;
                                                          _M_ltCounter++;
                                                          type_parameter_ast *__node_402 = 0;
                                                          if (!parse_type_parameter(&__node_402))
                                                            {
                                                              return yy_expected_symbol(ast_node::Kind_type_parameter, "type_parameter");
                                                            }
                                                          (*yynode)->type_parameter_sequence = snoc((*yynode)->type_parameter_sequence, __node_402, memory_pool);
                                                          while (yytoken == Token_COMMA)
                                                            {
                                                              if (yytoken != Token_COMMA)
                                                                return yy_expected_token(yytoken, Token_COMMA, ",");
                                                              yylex();
                                                              type_parameter_ast *__node_403 = 0;
                                                              if (!parse_type_parameter(&__node_403))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_type_parameter, "type_parameter");
                                                                }
                                                              (*yynode)->type_parameter_sequence = snoc((*yynode)->type_parameter_sequence, __node_403, memory_pool);
                                                            }
                                                          if (yytoken == Token_GREATER_THAN
                                                              || yytoken == Token_RSHIFT)
                                                            {
                                                              type_arguments_or_parameters_end_ast *__node_404 = 0;
                                                              if (!parse_type_arguments_or_parameters_end(&__node_404))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_type_arguments_or_parameters_end, "type_arguments_or_parameters_end");
                                                                }
                                                            }
                                                      ...
                                                      if (yytoken == Token_TYPEOF)
                                                        {
                                                          ...
                                                          if ((yytoken == Token_VOID) && ( LA(2).kind == Token_RPAREN ))
                                                            ...
                                                            {
                                                              unbound_type_name_ast *__node_405 = 0;
                                                              if (!parse_unbound_type_name(&__node_405))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_unbound_type_name, "unbound_type_name");
                                                                }
                                                              (*yynode)->unbound_type_name = __node_405;
                                                              (*yynode)->typeof_type = typeof_expression::type_unbound_type_name;
                                                                   ...
                                                                   || yytoken == Token_IDENTIFIER)
                                                            {
                                                              type_ast *__node_406 = 0;
                                                              if (!parse_type(&__node_406))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_type, "type");
                                                                }
                                                              (*yynode)->other_type = __node_406;
                                                          ...
                                                          || yytoken == Token_IDENTIFIER)
                                                        {
                                                          if (yytoken == Token_INCREMENT)
                                                          ...
                                                          else if (yytoken == Token_DECREMENT)
                                                            {
                                                              ...
                                                              (*yynode)->unary_expression = __node_408;
                                                            ...
                                                            {
                                                              cast_expression_ast *__node_413 = 0;
                                                              if (!parse_cast_expression(&__node_413))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_cast_expression, "cast_expression");
                                                                }
                                                              (*yynode)->cast_expression = __node_413;
                                                              (*yynode)->rule_type = unary_expression::type_cast_expression;
                                                                   ...
                                                                   || yytoken == Token_IDENTIFIER)
                                                            {
                                                              primary_expression_ast *__node_414 = 0;
                                                              if (!parse_primary_expression(&__node_414))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_primary_expression, "primary_expression");
                                                                }
                                                              (*yynode)->primary_expression = __node_414;
                                                      ...
                                                      if (yytoken == Token_OPERATOR)
                                                        {
                                                          ...
                                                          if (yytoken == Token_BANG
                                                              ...
                                                              || yytoken == Token_FALSE)
                                                            {
                                                              overloadable_unary_only_operator_ast *__node_417 = 0;
                                                              if (!parse_overloadable_unary_only_operator(&__node_417, &(*yynode)->overloadable_operator_type))
                                                                {
                                                              ...
                                                              if (yytoken != Token_LPAREN)
                                                                return yy_expected_token(yytoken, Token_LPAREN, "(");
                                                              yylex();
                                                              type_ast *__node_418 = 0;
                                                              if (!parse_type(&__node_418))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_type, "type");
                                                                }
                                                              (*yynode)->source1_type = __node_418;
                                                              identifier_ast *__node_419 = 0;
                                                              if (!parse_identifier(&__node_419))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_identifier, "identifier");
                                                                }
                                                              (*yynode)->source1_name = __node_419;
                                                              if (yytoken != Token_RPAREN)
                                                                return yy_expected_token(yytoken, Token_RPAREN, ")");
                                                              yylex();
                                                              ...
                                                              (*yynode)->unary_or_binary = overloadable_operator::type_unary;
                                                                   ...
                                                                   || yytoken == Token_RSHIFT)
                                                            {
                                                              overloadable_binary_only_operator_ast *__node_420 = 0;
                                                              if (!parse_overloadable_binary_only_operator(&__node_420, &(*yynode)->overloadable_operator_type))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_overloadable_binary_only_operator, "overloadable_binary_only_operator");
                                                                }
                                                              binary_op = __node_420;
                                                              if (yytoken != Token_LPAREN)
                                                                return yy_expected_token(yytoken, Token_LPAREN, "(");
                                                              yylex();
                                                              type_ast *__node_421 = 0;
                                                              if (!parse_type(&__node_421))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_type, "type");
                                                                }
                                                              (*yynode)->source1_type = __node_421;
                                                              identifier_ast *__node_422 = 0;
                                                              if (!parse_identifier(&__node_422))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_identifier, "identifier");
                                                                }
                                                              (*yynode)->source1_name = __node_422;
                                                              if (yytoken != Token_COMMA)
                                                                return yy_expected_token(yytoken, Token_COMMA, ",");
                                                              yylex();
                                                              ...
                                                              (*yynode)->source2_type = __node_423;
                                                              identifier_ast *__node_424 = 0;
                                                              if (!parse_identifier(&__node_424))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_identifier, "identifier");
                                                                }
                                                              (*yynode)->source2_name = __node_424;
                                                              if (yytoken != Token_RPAREN)
                                                                return yy_expected_token(yytoken, Token_RPAREN, ")");
                                                              yylex();
                                                              ...
                                                              (*yynode)->unary_or_binary = overloadable_operator::type_binary;
                                                                   ...
                                                                   || yytoken == Token_MINUS)
                                                            {
                                                              overloadable_unary_or_binary_operator_ast *__node_425 = 0;
                                                              if (!parse_overloadable_unary_or_binary_operator(&__node_425, &(*yynode)->overloadable_operator_type))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_overloadable_unary_or_binary_operator, "overloadable_unary_or_binary_operator");
                                                                }
                                                              unary_or_binary_op = __node_425;
                                                              ...
                                                              if (yytoken == Token_COMMA)
                                                                {
                                                                  ...
                                                                  (*yynode)->source2_type = __node_428;
                                                                  identifier_ast *__node_429 = 0;
                                                                  if (!parse_identifier(&__node_429))
                                                                    {
                                                                      return yy_expected_symbol(ast_node::Kind_identifier, "identifier");
                                                                    }
                                                                  (*yynode)->source2_name = __node_429;
                                                                  (*yynode)->unary_or_binary = overloadable_operator::type_binary;
                                                                }
                                                              else if (true /*epsilon*/)
                                                                {
                                                          ...
                                                          if (yytoken == Token_LBRACE)
                                                            {
                                                              block_ast *__node_430 = 0;
                                                              if (!parse_block(&__node_430))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_block, "block");
                                                                }
                                                              (*yynode)->body = __node_430;
                                                            }
                                                          else if (yytoken == Token_SEMICOLON)
                                                            {
                                                              if (yytoken != Token_SEMICOLON)
                                                          ...
                                                          || yytoken == Token_IDENTIFIER)
                                                        {
                                                          if ((yytoken == Token_ADD
                                                               ...
                                                               || yytoken == Token_IDENTIFIER) && ( LA(2).kind == Token_SCOPE ))
                                                            {
                                                              ...
                                                              (*yynode)->qualified_alias_label = __node_431;
                                                              if (yytoken != Token_SCOPE)
                                                                return yy_expected_token(yytoken, Token_SCOPE, "::");
                                                              yylex();
                                                            }
                                                          ...
                                                          unbound_type_name_part_ast *__node_432 = 0;
                                                          if (!parse_unbound_type_name_part(&__node_432))
                                                            {
                                                              return yy_expected_symbol(ast_node::Kind_unbound_type_name_part, "unbound_type_name_part");
                                                            }
                                                          (*yynode)->name_part_sequence = snoc((*yynode)->name_part_sequence, __node_432, memory_pool);
                                                          while (yytoken == Token_DOT)
                                                            {
                                                              if (yytoken != Token_DOT)
                                                                return yy_expected_token(yytoken, Token_DOT, ".");
                                                              yylex();
                                                              unbound_type_name_part_ast *__node_433 = 0;
                                                              if (!parse_unbound_type_name_part(&__node_433))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_unbound_type_name_part, "unbound_type_name_part");
                                                                }
                                                              (*yynode)->name_part_sequence = snoc((*yynode)->name_part_sequence, __node_433, memory_pool);
                                                            }
                                                        }
                                                      else
                                                        {
                                                    ...
                                                    bool parser::parse_unbound_type_name_part(unbound_type_name_part_ast **yynode)
                                                    {
                                                      *yynode = create<unbound_type_name_part_ast>();
                                                      ...
                                                      if (yytoken == Token_ADD
                                                          ...
                                                          || yytoken == Token_IDENTIFIER)
                                                        {
                                                          identifier_ast *__node_434 = 0;
                                                          if (!parse_identifier(&__node_434))
                                                            {
                                                              return yy_expected_symbol(ast_node::Kind_identifier, "identifier");
                                                            }
                                                          (*yynode)->identifier = __node_434;
                                                          if (yytoken == Token_LESS_THAN)
                                                            {
                                                              generic_dimension_specifier_ast *__node_435 = 0;
                                                              if (!parse_generic_dimension_specifier(&__node_435))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_generic_dimension_specifier, "generic_dimension_specifier");
                                                                }
                                                              (*yynode)->generic_dimension_specifier = __node_435;
                                                            }
                                                          else if (true /*epsilon*/)
                                                          {}
                                                          else
                                                      ...
                                                      if (yytoken == Token_BOOL
                                                          ...
                                                          || yytoken == Token_IDENTIFIER)
                                                        {
                                                          ...
                                                          if (yytoken == Token_BOOL
                                                              ...
                                                              || yytoken == Token_IDENTIFIER)
                                                            {
                                                              managed_type_ast *__node_437 = 0;
                                                              if (!parse_managed_type(&__node_437))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_managed_type, "managed_type");
                                                                }
                                                              (*yynode)->regular_type = __node_437;
                                                              (*yynode)->type = pointer_type::type_regular;
                                                            }
                                                          else if (yytoken == Token_VOID)
                                                            {
                                                      ...
                                                      if (yytoken == Token_USING)
                                                        {
                                                          ...
                                                          if ((yytoken == Token_ADD
                                                               ...
                                                               || yytoken == Token_IDENTIFIER) && ( LA(2).kind == Token_ASSIGN ))
                                                            {
                                                              ...
                                                              (*yynode)->alias = __node_439;
                                                              if (yytoken != Token_ASSIGN)
                                                                return yy_expected_token(yytoken, Token_ASSIGN, "=");
                                                              yylex();
                                                              namespace_or_type_name_ast *__node_440 = 0;
                                                              if (!parse_namespace_or_type_name(&__node_440))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_namespace_or_type_name, "namespace_or_type_name");
                                                                }
                                                              (*yynode)->namespace_or_type_name = __node_440;
                                                            }
                                                          else if (yytoken == Token_ADD
                                                                   || yytoken == Token_ALIAS
                                                                   || yytoken == Token_GET
                                                                   ...
                                                                   || yytoken == Token_IDENTIFIER)
                                                            {
                                                              namespace_or_type_name_ast *__node_441 = 0;
                                                              if (!parse_namespace_or_type_name(&__node_441))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_namespace_or_type_name, "namespace_or_type_name");
                                                                }
                                                              (*yynode)->namespace_name = __node_441;
                                                            }
                                                          else
                                                            {
                                                              return false;
                                                      ...
                                                      if (yytoken == Token_USING)
                                                        {
                                                          ...
                                                          if (yytoken != Token_LPAREN)
                                                            return yy_expected_token(yytoken, Token_LPAREN, "(");
                                                          yylex();
                                                          resource_acquisition_ast *__node_442 = 0;
                                                          if (!parse_resource_acquisition(&__node_442))
                                                            {
                                                              return yy_expected_symbol(ast_node::Kind_resource_acquisition, "resource_acquisition");
                                                            }
                                                          (*yynode)->resource_acquisition = __node_442;
                                                          if (yytoken != Token_RPAREN)
                                                            return yy_expected_token(yytoken, Token_RPAREN, ")");
                                                          yylex();
                                                          embedded_statement_ast *__node_443 = 0;
                                                          if (!parse_embedded_statement(&__node_443))
                                                            {
                                                              return yy_expected_symbol(ast_node::Kind_embedded_statement, "embedded_statement");
                                                            }
                                                          (*yynode)->body = __node_443;
                                                        }
                                                      else
                                                        {
                                                          return false;
                                                    ...
                                                    bool parser::parse_variable_declarator(variable_declarator_ast **yynode)
                                                    {
                                                      *yynode = create<variable_declarator_ast>();
                                                      ...
                                                      if (yytoken == Token_ADD
                                                          ...
                                                          || yytoken == Token_IDENTIFIER)
                                                        {
                                                          identifier_ast *__node_444 = 0;
                                                          if (!parse_identifier(&__node_444))
                                                            {
                                                              return yy_expected_symbol(ast_node::Kind_identifier, "identifier");
                                                            }
                                                          (*yynode)->variable_name = __node_444;
                                                          if (yytoken == Token_ASSIGN)
                                                            {
                                                              if (yytoken != Token_ASSIGN)
                                                                return yy_expected_token(yytoken, Token_ASSIGN, "=");
                                                              yylex();
                                                              variable_initializer_ast *__node_445 = 0;
                                                              if (!parse_variable_initializer(&__node_445))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_variable_initializer, "variable_initializer");
                                                                }
                                                              (*yynode)->variable_initializer = __node_445;
                                                            }
                                                          else if (true /*epsilon*/)
                                                          {}
                                                          else
                                                      ...
                                                      if (yytoken == Token_BASE
                                                          ...
                                                          || yytoken == Token_IDENTIFIER)
                                                        {
                                                          if (yytoken == Token_BASE
                                                              ...
                                                              || yytoken == Token_IDENTIFIER)
                                                            {
                                                              expression_ast *__node_446 = 0;
                                                              if (!parse_expression(&__node_446))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_expression, "expression");
                                                                }
                                                              (*yynode)->expression = __node_446;
                                                            }
                                                          else if (yytoken == Token_LBRACE)
                                                            {
                                                              array_initializer_ast *__node_447 = 0;
                                                              if (!parse_array_initializer(&__node_447))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_array_initializer, "array_initializer");
                                                                }
                                                              (*yynode)->array_initializer = __node_447;
                                                            }
                                                          else if (yytoken == Token_STACKALLOC)
                                                            {
                                                              stackalloc_initializer_ast *__node_448 = 0;
                                                              if (!parse_stackalloc_initializer(&__node_448))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_stackalloc_initializer, "stackalloc_initializer");
                                                                }
                                                              (*yynode)->stackalloc_initializer = __node_448;
                                                            }
                                                          else
                                                            {
                                                              return false;
                                                      ...
                                                      if (yytoken == Token_WHILE)
                                                        {
                                                          ...
                                                          if (yytoken != Token_LPAREN)
                                                            return yy_expected_token(yytoken, Token_LPAREN, "(");
                                                          yylex();
                                                          boolean_expression_ast *__node_449 = 0;
                                                          if (!parse_boolean_expression(&__node_449))
                                                            {
                                                              return yy_expected_symbol(ast_node::Kind_boolean_expression, "boolean_expression");
                                                            }
                                                          (*yynode)->condition = __node_449;
                                                          if (yytoken != Token_RPAREN)
                                                            return yy_expected_token(yytoken, Token_RPAREN, ")");
                                                          yylex();
                                                          embedded_statement_ast *__node_450 = 0;
                                                          if (!parse_embedded_statement(&__node_450))
                                                            {
                                                              return yy_expected_symbol(ast_node::Kind_embedded_statement, "embedded_statement");
                                                            }
                                                          (*yynode)->body = __node_450;
                                                        }
                                                      else
                                                        {
                                                          return false;
                                                          ...
                                                          if (yytoken == Token_RETURN)
                                                            {
                                                              if (yytoken != Token_RETURN)
                                                                return yy_expected_token(yytoken, Token_RETURN, "return");
                                                              yylex();
                                                              expression_ast *__node_451 = 0;
                                                              if (!parse_expression(&__node_451))
                                                                {
                                                                  return yy_expected_symbol(ast_node::Kind_expression, "expression");
                                                                }
                                                              (*yynode)->return_expression = __node_451;
